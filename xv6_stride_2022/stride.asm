...
_stride:     file format elf32-i386
...
int main(void)
{
  ...
  stridetest();
  11:	e8 0a 00 00 00       	call   20 <stridetest>
  exit();
  16:	e8 b7 03 00 00       	call   3d2 <exit>
  1b:	66 90                	xchg   %ax,%ax
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
  ...
  26:	31 db                	xor    %ebx,%ebx
{
  ...
  37:	83 c4 10             	add    $0x10,%esp
    pid = fork();
  3a:	e8 8b 03 00 00       	call   3ca <fork>
    if (pid < 0)
  3f:	85 c0                	test   %eax,%eax
  41:	78 4d                	js     90 <stridetest+0x70>
  43:	83 c3 01             	add    $0x1,%ebx
    if (pid == 0)
  46:	85 c0                	test   %eax,%eax
  48:	74 60                	je     aa <stridetest+0x8a>
  for (n = 0; n < N; n++)
  4a:	83 fb 03             	cmp    $0x3,%ebx
  4d:	75 eb                	jne    3a <stridetest+0x1a>
  4f:	90                   	nop
    if (wait() < 0)
  50:	e8 85 03 00 00       	call   3da <wait>
  55:	85 c0                	test   %eax,%eax
  57:	78 3d                	js     96 <stridetest+0x76>
  for (; n > 0; n--)
  59:	83 eb 01             	sub    $0x1,%ebx
  5c:	75 f2                	jne    50 <stridetest+0x30>
  if (wait() != -1)
  5e:	e8 77 03 00 00       	call   3da <wait>
  63:	83 f8 ff             	cmp    $0xffffffff,%eax
  66:	0f 85 f3 00 00 00    	jne    15f <stridetest+0x13f>
  printf(1, "stride scheduling test OK\n");
  6c:	83 ec 08             	sub    $0x8,%esp
  6f:	68 e3 08 00 00       	push   $0x8e3
  74:	6a 01                	push   $0x1
  76:	e8 a5 04 00 00       	call   520 <printf>
}
  ...
  92:	74 ca                	je     5e <stridetest+0x3e>
  94:	eb ba                	jmp    50 <stridetest+0x30>
      printf(1, "wait stopped early\n");
  96:	83 ec 08             	sub    $0x8,%esp
  99:	68 bc 08 00 00       	push   $0x8bc
  9e:	6a 01                	push   $0x1
  a0:	e8 7b 04 00 00       	call   520 <printf>
      exit();
  a5:	e8 28 03 00 00       	call   3d2 <exit>
      int tickets = 100 * (n + 1);
  aa:	6b c3 64             	imul   $0x64,%ebx,%eax
      stride(tickets);
  ...
  bd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      stride(tickets);
  c0:	e8 ad 03 00 00       	call   472 <stride>
      uint start_ticks = uptime();
  c5:	e8 a0 03 00 00       	call   46a <uptime>
  ca:	83 c4 10             	add    $0x10,%esp
  cd:	89 45 e0             	mov    %eax,-0x20(%ebp)
        print_counter--;
  d0:	ba ff e0 f5 05       	mov    $0x5f5e0ff,%edx
  d5:	eb 16                	jmp    ed <stridetest+0xcd>
  d7:	89 f6                	mov    %esi,%esi
  d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      while (counter <= MAX_COUNTER)
  e0:	89 f0                	mov    %esi,%eax
  e2:	89 f9                	mov    %edi,%ecx
  e4:	35 01 65 cd 1d       	xor    $0x1dcd6501,%eax
  e9:	09 c1                	or     %eax,%ecx
  eb:	74 58                	je     145 <stridetest+0x125>
        counter++;
  ed:	83 c6 01             	add    $0x1,%esi
  f0:	83 d7 00             	adc    $0x0,%edi
        if (print_counter == 0)
  f3:	83 ea 01             	sub    $0x1,%edx
  f6:	75 e8                	jne    e0 <stridetest+0xc0>
          if (first)
  f8:	85 db                	test   %ebx,%ebx
          print_counter = PRINT_TIME;
  fa:	ba 00 e1 f5 05       	mov    $0x5f5e100,%edx
          if (first)
  ff:	74 df                	je     e0 <stridetest+0xc0>
 101:	89 55 dc             	mov    %edx,-0x24(%ebp)
            end_ticks = uptime();
 104:	e8 61 03 00 00       	call   46a <uptime>
 109:	89 c3                	mov    %eax,%ebx
            printf(1, "PID: %d (tickets: %d), ", getpid(), tickets);
 10b:	e8 42 03 00 00       	call   452 <getpid>
 110:	ff 75 e4             	pushl  -0x1c(%ebp)
 113:	50                   	push   %eax
 114:	68 90 08 00 00       	push   $0x890
 119:	6a 01                	push   $0x1
 11b:	e8 00 04 00 00       	call   520 <printf>
            printf(1, "it takes %d milliseconds to complete %d additions.\n", (end_ticks - start_ticks) * 10, counter);
 120:	89 d8                	mov    %ebx,%eax
 122:	2b 45 e0             	sub    -0x20(%ebp),%eax
 125:	89 3c 24             	mov    %edi,(%esp)
 128:	56                   	push   %esi
            first = 0;
 129:	31 db                	xor    %ebx,%ebx
            printf(1, "it takes %d milliseconds to complete %d additions.\n", (end_ticks - start_ticks) * 10, counter);
 12b:	8d 04 80             	lea    (%eax,%eax,4),%eax
 12e:	01 c0                	add    %eax,%eax
 130:	50                   	push   %eax
 131:	68 00 09 00 00       	push   $0x900
 136:	6a 01                	push   $0x1
 138:	e8 e3 03 00 00       	call   520 <printf>
 13d:	83 c4 20             	add    $0x20,%esp
            first = 0;
 140:	8b 55 dc             	mov    -0x24(%ebp),%edx
 143:	eb 9b                	jmp    e0 <stridetest+0xc0>
      printf(1, "PID: %d terminated\n", getpid());
 145:	e8 08 03 00 00       	call   452 <getpid>
 14a:	83 ec 04             	sub    $0x4,%esp
 14d:	50                   	push   %eax
 14e:	68 a8 08 00 00       	push   $0x8a8
 153:	6a 01                	push   $0x1
 155:	e8 c6 03 00 00       	call   520 <printf>
      exit();
 15a:	e8 73 02 00 00       	call   3d2 <exit>
    printf(1, "wait got too many\n");
 15f:	50                   	push   %eax
 160:	50                   	push   %eax
 161:	68 d0 08 00 00       	push   $0x8d0
 166:	6a 01                	push   $0x1
 168:	e8 b3 03 00 00       	call   520 <printf>
    exit();
 16d:	e8 60 02 00 00       	call   3d2 <exit>
 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4b7:	f7 f1                	div    %ecx
 4b9:	0f b6 92 3c 09 00 00 	movzbl 0x93c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6d4:	e9 8f fe ff ff       	jmp    568 <printf+0x48>
          s = "(null)";
 6d9:	bb 34 09 00 00       	mov    $0x934,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 10 0c 00 00       	mov    0xc10,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 72f:	a3 10 0c 00 00       	mov    %eax,0xc10
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 10 0c 00 00       	mov    %eax,0xc10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 10 0c 00 00    	mov    0xc10,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 47                	jae    818 <malloc+0x98>
    ...
    if(p == freep)
 7d1:	39 05 10 0c 00 00    	cmp    %eax,0xc10
 ...
 7f6:	e8 f5 fe ff ff       	call   6f0 <free>
  return freep;
 7fb:	8b 15 10 0c 00 00    	mov    0xc10,%edx
 ...
 824:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 827:	89 15 10 0c 00 00    	mov    %edx,0xc10
}
 ...
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 10 0c 00 00 14 	movl   $0xc14,0xc10
 847:	0c 00 00 
 84a:	c7 05 14 0c 00 00 14 	movl   $0xc14,0xc14
 851:	0c 00 00 
    base.s.size = 0;
 854:	b8 14 0c 00 00       	mov    $0xc14,%eax
 859:	c7 05 18 0c 00 00 00 	movl   $0x0,0xc18
 860:	00 00 00 
