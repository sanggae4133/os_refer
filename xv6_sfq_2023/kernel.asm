...
801002ef:	e8 4c 43 00 00       	call   80104640 <release>
        ilock(ip);
...
8010034d:	e8 ee 42 00 00       	call   80104640 <release>
  ilock(ip);
...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 bb 7a 10 80 	movl   $0x80107abb,(%esp)
...
801003d8:	e8 83 40 00 00       	call   80104460 <getcallerpcs>
...
8010043a:	e8 01 59 00 00       	call   80105d40 <uartputc>
...
801004ec:	e8 4f 58 00 00       	call   80105d40 <uartputc>
801004f1:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f8:	e8 43 58 00 00       	call   80105d40 <uartputc>
801004fd:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100504:	e8 37 58 00 00       	call   80105d40 <uartputc>
...
8010071f:	e8 1c 3f 00 00       	call   80104640 <release>
...
801007f0:	e8 8b 3d 00 00       	call   80104580 <acquire>
...
80100823:	e8 58 3d 00 00       	call   80104580 <acquire>
  while((c = getc()) >= 0){
...
80100888:	e8 b3 3d 00 00       	call   80104640 <release>
  if(doprocdump) {
...
801009d0:	e8 6b 3a 00 00       	call   80104440 <initlock>
...
80100a92:	75 d2                	jne    80100a66 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a94:	e8 f7 63 00 00       	call   80106e90 <setupkvm>
...
80100af6:	e8 b5 61 00 00       	call   80106cb0 <allocuvm>
...
80100b28:	e8 c3 60 00 00       	call   80106bf0 <loaduvm>
...
80100b72:	e8 99 62 00 00       	call   80106e10 <freevm>
...
80100baa:	e8 01 61 00 00       	call   80106cb0 <allocuvm>
...
80100bc1:	e8 4a 62 00 00       	call   80106e10 <freevm>
...
80100c06:	e8 25 63 00 00       	call   80106f30 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c5d:	e8 2e 64 00 00       	call   80107090 <copyout>
...
80100d34:	e8 27 5d 00 00       	call   80106a60 <switchuvm>
  freevm(oldpgdir);
80100d39:	89 3c 24             	mov    %edi,(%esp)
80100d3c:	e8 cf 60 00 00       	call   80106e10 <freevm>
  return 0;
...
80100d91:	e8 ea 37 00 00       	call   80104580 <acquire>
...
80100dc1:	e8 7a 38 00 00       	call   80104640 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dda:	e8 61 38 00 00       	call   80104640 <release>
}
...
80100dff:	e8 7c 37 00 00       	call   80104580 <acquire>
  if(f->ref < 1)
...
80100e1c:	e8 1f 38 00 00       	call   80104640 <release>
  return f;
}
...
80100e51:	e8 2a 37 00 00       	call   80104580 <acquire>
  if(f->ref < 1)
...
80100e7b:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e7c:	e9 bf 37 00 00       	jmp    80104640 <release>
...
80100ea5:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100ea8:	e8 93 37 00 00       	call   80104640 <release>
  if(ff.type == FD_PIPE)
...
8010123a:	e8 41 33 00 00       	call   80104580 <acquire>
...
801012ca:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012cd:	e8 6e 33 00 00       	call   80104640 <release>
      return ip;
...
801014a6:	e8 95 2f 00 00       	call   80104440 <initlock>
...
8010166f:	e8 0c 2f 00 00       	call   80104580 <acquire>
  ip->ref++;
80101674:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101678:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010167f:	e8 bc 2f 00 00       	call   80104640 <release>
}
...
801017f6:	e8 85 2d 00 00       	call   80104580 <acquire>
  ip->ref--;
...
8010180f:	5d                   	pop    %ebp
  release(&icache.lock);
80101810:	e9 2b 2e 00 00       	jmp    80104640 <release>
80101815:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101818:	83 ec 0c             	sub    $0xc,%esp
8010181b:	68 e0 09 11 80       	push   $0x801109e0
80101820:	e8 5b 2d 00 00       	call   80104580 <acquire>
    int r = ip->ref;
80101825:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101828:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010182f:	e8 0c 2e 00 00       	call   80104640 <release>
    if(r == 1){
...
80101c83:	0f 84 67 01 00 00    	je     80101df0 <namex+0x180>
    ...
    ip = idup(myproc()->cwd);
80101c89:	e8 d2 1c 00 00       	call   80103960 <myproc>
  acquire(&icache.lock);
...
80101c99:	e8 e2 28 00 00       	call   80104580 <acquire>
  ip->ref++;
80101c9e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101ca2:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101ca9:	e8 92 29 00 00       	call   80104640 <release>
...
80101ed8:	68 a2 78 10 80       	push   $0x801078a2
...
80102020:	e8 1b 24 00 00       	call   80104440 <initlock>
...
8010209e:	e8 dd 24 00 00       	call   80104580 <acquire>
...
80102101:	e8 4a 20 00 00       	call   80104150 <wakeup>
...
8010211f:	e8 1c 25 00 00       	call   80104640 <release>
...
8010213e:	e8 ad 22 00 00       	call   801043f0 <holdingsleep>
...
80102178:	e8 03 24 00 00       	call   80104580 <acquire>
...
801021e5:	c9                   	leave  
  release(&idelock);
801021e6:	e9 55 24 00 00       	jmp    80104640 <release>
801021eb:	90                   	nop
...
80102332:	81 fb 48 58 11 80    	cmp    $0x80115848,%ebx
...
80102352:	e8 39 23 00 00       	call   80104690 <memset>
...
8010238a:	c9                   	leave  
    release(&kmem.lock);
8010238b:	e9 b0 22 00 00       	jmp    80104640 <release>
    acquire(&kmem.lock);
...
80102415:	e8 26 20 00 00       	call   80104440 <initlock>
  p = (char *)PGROUNDUP((uint)vstart);
...
80102503:	e8 78 20 00 00       	call   80104580 <acquire>
  r = kmem.freelist;
...
80102531:	e8 0a 21 00 00       	call   80104640 <release>
  return (char *)r;
...
80102947:	e8 94 1d 00 00       	call   801046e0 <memcmp>
...
80102bbb:	e8 c0 19 00 00       	call   80104580 <acquire>
...
80102c2e:	e8 4d 19 00 00       	call   80104580 <acquire>
  log.outstanding -= 1;
...
80102c6c:	e8 cf 19 00 00       	call   80104640 <release>
}
...
80102cc6:	e8 75 1a 00 00       	call   80104740 <memmove>
...
80102d0f:	e8 6c 18 00 00       	call   80104580 <acquire>
    wakeup(&log);
...
80102d22:	00 00 00 
    wakeup(&log);
80102d25:	e8 26 14 00 00       	call   80104150 <wakeup>
    release(&log.lock);
80102d2a:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d31:	e8 0a 19 00 00       	call   80104640 <release>
...
80102d50:	e8 fb 13 00 00       	call   80104150 <wakeup>
  release(&log.lock);
80102d55:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d5c:	e8 df 18 00 00       	call   80104640 <release>
...
80102dbe:	e8 bd 17 00 00       	call   80104580 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e0c:	c9                   	leave  
  release(&log.lock);
80102e0d:	e9 2e 18 00 00       	jmp    80104640 <release>
...
80102e57:	e8 e4 0a 00 00       	call   80103940 <cpuid>
80102e5c:	89 c3                	mov    %eax,%ebx
80102e5e:	e8 dd 0a 00 00       	call   80103940 <cpuid>
...
80102e72:	e8 d9 2a 00 00       	call   80105950 <idtinit>
...
80102e8a:	e8 a1 0d 00 00       	call   80103c30 <scheduler>
80102e8f:	90                   	nop
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 a5 3b 00 00       	call   80106a40 <switchkvm>
  seginit();
80102e9b:	e8 10 3b 00 00       	call   801069b0 <seginit>
  lapicinit();
...
80102ec7:	68 48 58 11 80       	push   $0x80115848
80102ecc:	e8 2f f5 ff ff       	call   80102400 <kinit1>
  kvmalloc();      // kernel page table
80102ed1:	e8 3a 40 00 00       	call   80106f10 <kvmalloc>
  mpinit();        // detect other processors
80102ed6:	e8 75 01 00 00       	call   80103050 <mpinit>
  lapicinit();     // interrupt controller
80102edb:	e8 60 f7 ff ff       	call   80102640 <lapicinit>
  seginit();       // segment descriptors
80102ee0:	e8 cb 3a 00 00       	call   801069b0 <seginit>
  picinit();       // disable pic
...
80102ef4:	e8 87 2d 00 00       	call   80105c80 <uartinit>
  pinit();         // process table
80102ef9:	e8 a2 09 00 00       	call   801038a0 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 cd 29 00 00       	call   801058d0 <tvinit>
  binit();         // buffer cache
...
80102f24:	e8 17 18 00 00       	call   80104740 <memmove>
...
80102fc5:	e8 c6 09 00 00       	call   80103990 <userinit>
...
80103004:	e8 d7 16 00 00       	call   801046e0 <memcmp>
...
801030c2:	e8 19 16 00 00       	call   801046e0 <memcmp>
...
80103311:	e8 2a 11 00 00       	call   80104440 <initlock>
  (*f0)->type = FD_PIPE;
...
8010336f:	e8 0c 12 00 00       	call   80104580 <acquire>
  if(writable){
...
8010338f:	e8 bc 0d 00 00       	call   80104150 <wakeup>
...
801033b3:	5d                   	pop    %ebp
    release(&p->lock);
801033b4:	e9 87 12 00 00       	jmp    80104640 <release>
...
801033d4:	e8 77 0d 00 00       	call   80104150 <wakeup>
...
801033e4:	e8 57 12 00 00       	call   80104640 <release>
    kfree((char*)p);
...
8010340d:	e8 6e 11 00 00       	call   80104580 <acquire>
  for(i = 0; i < n; i++){
...
80103464:	e8 e7 0c 00 00       	call   80104150 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103469:	5a                   	pop    %edx
8010346a:	59                   	pop    %ecx
8010346b:	53                   	push   %ebx
8010346c:	56                   	push   %esi
8010346d:	e8 1e 0b 00 00       	call   80103f90 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103494:	e8 c7 04 00 00       	call   80103960 <myproc>
...
801034f3:	e8 58 0c 00 00       	call   80104150 <wakeup>
  release(&p->lock);
801034f8:	89 1c 24             	mov    %ebx,(%esp)
801034fb:	e8 40 11 00 00       	call   80104640 <release>
  return n;
...
80103520:	e8 5b 10 00 00       	call   80104580 <acquire>
...
80103555:	e8 36 0a 00 00       	call   80103f90 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103573:	0f 84 8f 00 00 00    	je     80103608 <piperead+0xf8>
    if(myproc()->killed){
80103579:	e8 e2 03 00 00       	call   80103960 <myproc>
...
8010358e:	e8 ad 10 00 00       	call   80104640 <release>
      return -1;
...
801035e7:	e8 64 0b 00 00       	call   80104150 <wakeup>
  release(&p->lock);
801035ec:	89 34 24             	mov    %esi,(%esp)
801035ef:	e8 4c 10 00 00       	call   80104640 <release>
  return i;
...
80103621:	e8 5a 0f 00 00       	call   80104580 <acquire>
...
80103636:	81 fb f4 4f 11 80    	cmp    $0x80114ff4,%ebx
...
8010364e:	83 ec 0c             	sub    $0xc,%esp
  p->weight = 1;
80103651:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
  p->state = EMBRYO;
80103658:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
8010365f:	8d 50 01             	lea    0x1(%eax),%edx
80103662:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103665:	68 c0 2d 11 80       	push   $0x80112dc0
  p->pid = nextpid++;
8010366a:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103670:	e8 cb 0f 00 00       	call   80104640 <release>

  // Allocate kernel stack.
  if ((p->kstack = kalloc()) == 0)
80103675:	e8 56 ee ff ff       	call   801024d0 <kalloc>
8010367a:	83 c4 10             	add    $0x10,%esp
8010367d:	85 c0                	test   %eax,%eax
8010367f:	89 43 08             	mov    %eax,0x8(%ebx)
80103682:	74 55                	je     801036d9 <allocproc+0xc9>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
80103684:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
8010368a:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
8010368d:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103692:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint *)sp = (uint)trapret;
80103695:	c7 40 14 bf 58 10 80 	movl   $0x801058bf,0x14(%eax)
  p->context = (struct context *)sp;
8010369c:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010369f:	6a 14                	push   $0x14
801036a1:	6a 00                	push   $0x0
801036a3:	50                   	push   %eax
801036a4:	e8 e7 0f 00 00       	call   80104690 <memset>
...
801036ac:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
801036af:	c7 40 10 f0 36 10 80 	movl   $0x801036f0,0x10(%eax)
}
801036b6:	89 d8                	mov    %ebx,%eax
801036b8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801036bb:	c9                   	leave  
801036bc:	c3                   	ret    
...
801036c3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036c5:	68 c0 2d 11 80       	push   $0x80112dc0
801036ca:	e8 71 0f 00 00       	call   80104640 <release>
}
...
801036e2:	eb d2                	jmp    801036b6 <allocproc+0xa6>
...
801036f3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036f6:	68 c0 2d 11 80       	push   $0x80112dc0
801036fb:	e8 40 0f 00 00       	call   80104640 <release>
...
80103740 <sfq_schedule>:
{
80103740:	ba f4 2d 11 80       	mov    $0x80112df4,%edx
  struct proc *proc_sched = NULL;
80103745:	31 c0                	xor    %eax,%eax
80103747:	89 f6                	mov    %esi,%esi
80103749:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if (proc_temp -> state != RUNNABLE) { continue; }
80103750:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
80103754:	75 5c                	jne    801037b2 <sfq_schedule+0x72>
    if (proc_sched == NULL || proc_temp -> start_tag < proc_sched -> start_tag) {
80103756:	85 c0                	test   %eax,%eax
80103758:	74 56                	je     801037b0 <sfq_schedule+0x70>
{
8010375a:	55                   	push   %ebp
8010375b:	89 e5                	mov    %esp,%ebp
8010375d:	53                   	push   %ebx
    if (proc_sched == NULL || proc_temp -> start_tag < proc_sched -> start_tag) {
8010375e:	8b 98 84 00 00 00    	mov    0x84(%eax),%ebx
80103764:	39 9a 84 00 00 00    	cmp    %ebx,0x84(%edx)
8010376a:	8b 8a 80 00 00 00    	mov    0x80(%edx),%ecx
80103770:	7c 26                	jl     80103798 <sfq_schedule+0x58>
80103772:	7f 0c                	jg     80103780 <sfq_schedule+0x40>
80103774:	3b 88 80 00 00 00    	cmp    0x80(%eax),%ecx
8010377a:	72 1c                	jb     80103798 <sfq_schedule+0x58>
8010377c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103780:	81 c2 88 00 00 00    	add    $0x88,%edx
  for (int i = 0; i < NPROC; ++i) {
80103786:	81 fa f4 4f 11 80    	cmp    $0x80114ff4,%edx
8010378c:	74 1a                	je     801037a8 <sfq_schedule+0x68>
    if (proc_temp -> state != RUNNABLE) { continue; }
8010378e:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
80103792:	75 ec                	jne    80103780 <sfq_schedule+0x40>
    if (proc_sched == NULL || proc_temp -> start_tag < proc_sched -> start_tag) {
80103794:	85 c0                	test   %eax,%eax
80103796:	75 c6                	jne    8010375e <sfq_schedule+0x1e>
80103798:	89 d0                	mov    %edx,%eax
8010379a:	81 c2 88 00 00 00    	add    $0x88,%edx
  for (int i = 0; i < NPROC; ++i) {
801037a0:	81 fa f4 4f 11 80    	cmp    $0x80114ff4,%edx
801037a6:	75 e6                	jne    8010378e <sfq_schedule+0x4e>
}
801037a8:	5b                   	pop    %ebx
801037a9:	5d                   	pop    %ebp
801037aa:	c3                   	ret    
...
801037b0:	89 d0                	mov    %edx,%eax
801037b2:	81 c2 88 00 00 00    	add    $0x88,%edx
  for (int i = 0; i < NPROC; ++i) {
801037b8:	81 fa f4 4f 11 80    	cmp    $0x80114ff4,%edx
801037be:	75 90                	jne    80103750 <sfq_schedule+0x10>
801037c0:	c3                   	ret    
801037c1:	eb 0d                	jmp    801037d0 <update_start_tag>
801037c3:	90                   	nop
801037c4:	90                   	nop
801037c5:	90                   	nop
801037c6:	90                   	nop
...
801037d0 <update_start_tag>:
{
801037d0:	55                   	push   %ebp
  long long diff = TIME_SLICE / proc -> weight;
801037d1:	b8 80 96 98 00       	mov    $0x989680,%eax
801037d6:	99                   	cltd   
{
801037d7:	89 e5                	mov    %esp,%ebp
801037d9:	8b 4d 08             	mov    0x8(%ebp),%ecx
  long long diff = TIME_SLICE / proc -> weight;
801037dc:	f7 79 7c             	idivl  0x7c(%ecx)
801037df:	99                   	cltd   
  proc -> start_tag += diff;
801037e0:	01 81 80 00 00 00    	add    %eax,0x80(%ecx)
801037e6:	11 91 84 00 00 00    	adc    %edx,0x84(%ecx)
}
801037ec:	5d                   	pop    %ebp
801037ed:	c3                   	ret    
801037ee:	66 90                	xchg   %ax,%ax

801037f0 <update_min_start_tag>:
{
801037f0:	b8 f4 2d 11 80       	mov    $0x80112df4,%eax
  struct proc* proc_sched = NULL;
801037f5:	31 d2                	xor    %edx,%edx
801037f7:	89 f6                	mov    %esi,%esi
801037f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if (proc_temp -> state != RUNNABLE) { continue; }
80103800:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103804:	75 6a                	jne    80103870 <update_min_start_tag+0x80>
{
80103806:	55                   	push   %ebp
80103807:	89 e5                	mov    %esp,%ebp
80103809:	53                   	push   %ebx
    if (proc_sched == NULL || proc_temp -> start_tag < proc_sched -> start_tag) {
8010380a:	85 d2                	test   %edx,%edx
8010380c:	74 22                	je     80103830 <update_min_start_tag+0x40>
8010380e:	8b 8a 84 00 00 00    	mov    0x84(%edx),%ecx
80103814:	39 88 84 00 00 00    	cmp    %ecx,0x84(%eax)
8010381a:	8b 9a 80 00 00 00    	mov    0x80(%edx),%ebx
80103820:	7f 1c                	jg     8010383e <update_min_start_tag+0x4e>
80103822:	7c 0c                	jl     80103830 <update_min_start_tag+0x40>
80103824:	39 98 80 00 00 00    	cmp    %ebx,0x80(%eax)
8010382a:	73 12                	jae    8010383e <update_min_start_tag+0x4e>
8010382c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103830:	8b 98 80 00 00 00    	mov    0x80(%eax),%ebx
80103836:	8b 88 84 00 00 00    	mov    0x84(%eax),%ecx
  struct proc* proc_sched = NULL;
8010383c:	89 c2                	mov    %eax,%edx
8010383e:	05 88 00 00 00       	add    $0x88,%eax
      ptable.min_start_tag = proc_sched -> start_tag;
80103843:	89 1d f4 4f 11 80    	mov    %ebx,0x80114ff4
80103849:	89 0d f8 4f 11 80    	mov    %ecx,0x80114ff8
  for (int i = 0; i < NPROC; ++i) {
8010384f:	3d f4 4f 11 80       	cmp    $0x80114ff4,%eax
80103854:	74 12                	je     80103868 <update_min_start_tag+0x78>
    if (proc_temp -> state != RUNNABLE) { continue; }
80103856:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
8010385a:	74 ae                	je     8010380a <update_min_start_tag+0x1a>
8010385c:	05 88 00 00 00       	add    $0x88,%eax
  for (int i = 0; i < NPROC; ++i) {
80103861:	3d f4 4f 11 80       	cmp    $0x80114ff4,%eax
80103866:	75 ee                	jne    80103856 <update_min_start_tag+0x66>
}
80103868:	5b                   	pop    %ebx
80103869:	5d                   	pop    %ebp
8010386a:	c3                   	ret    
...
80103870:	05 88 00 00 00       	add    $0x88,%eax
  for (int i = 0; i < NPROC; ++i) {
80103875:	3d f4 4f 11 80       	cmp    $0x80114ff4,%eax
8010387a:	75 84                	jne    80103800 <update_min_start_tag+0x10>
8010387c:	f3 c3                	repz ret 
8010387e:	66 90                	xchg   %ax,%ax

80103880 <assign_min_start_tag>:
{
80103880:	55                   	push   %ebp
  proc -> start_tag = ptable.min_start_tag;
80103881:	a1 f4 4f 11 80       	mov    0x80114ff4,%eax
80103886:	8b 15 f8 4f 11 80    	mov    0x80114ff8,%edx
{
8010388c:	89 e5                	mov    %esp,%ebp
  proc -> start_tag = ptable.min_start_tag;
8010388e:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103891:	89 81 80 00 00 00    	mov    %eax,0x80(%ecx)
80103897:	89 91 84 00 00 00    	mov    %edx,0x84(%ecx)
}
8010389d:	5d                   	pop    %ebp
8010389e:	c3                   	ret    
8010389f:	90                   	nop
...
801038a6:	68 95 76 10 80       	push   $0x80107695
801038ab:	68 c0 2d 11 80       	push   $0x80112dc0
801038b0:	e8 8b 0b 00 00       	call   80104440 <initlock>
}
...
801038ca:	75 5e                	jne    8010392a <mycpu+0x6a>
  apicid = lapicid();
801038cc:	e8 6f ee ff ff       	call   80102740 <lapicid>
  for (i = 0; i < ncpu; ++i)
...
801038e6:	b9 30 28 11 80       	mov    $0x80112830,%ecx
  for (i = 0; i < ncpu; ++i)
...
8010390a:	05 80 27 11 80       	add    $0x80112780,%eax
}
...
8010394b:	2d 80 27 11 80       	sub    $0x80112780,%eax
}
80103950:	c9                   	leave  
  return mycpu() - cpus;
...
80103964:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103967:	e8 44 0b 00 00       	call   801044b0 <pushcli>
  c = mycpu();
8010396c:	e8 4f ff ff ff       	call   801038c0 <mycpu>
  p = c->proc;
80103971:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103977:	e8 74 0b 00 00       	call   801044f0 <popcli>
}
...
80103994:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103997:	e8 74 fc ff ff       	call   80103610 <allocproc>
8010399c:	89 c3                	mov    %eax,%ebx
  initproc = p;
8010399e:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
  if ((p->pgdir = setupkvm()) == 0)
801039a3:	e8 e8 34 00 00       	call   80106e90 <setupkvm>
...
801039c1:	e8 aa 31 00 00       	call   80106b70 <inituvm>
...
801039d6:	e8 b5 0c 00 00       	call   80104690 <memset>
...
80103a2f:	68 c5 76 10 80       	push   $0x801076c5
80103a34:	50                   	push   %eax
80103a35:	e8 36 0e 00 00       	call   80104870 <safestrcpy>
  p->cwd = namei("/");
80103a3a:	c7 04 24 ce 76 10 80 	movl   $0x801076ce,(%esp)
80103a41:	e8 aa e4 ff ff       	call   80101ef0 <namei>
80103a46:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a49:	c7 04 24 c0 2d 11 80 	movl   $0x80112dc0,(%esp)
80103a50:	e8 2b 0b 00 00       	call   80104580 <acquire>
  p->state = RUNNABLE;
80103a55:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a5c:	c7 04 24 c0 2d 11 80 	movl   $0x80112dc0,(%esp)
80103a63:	e8 d8 0b 00 00       	call   80104640 <release>
}
...
80103a73:	68 ac 76 10 80       	push   $0x801076ac
...
80103a85:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a88:	e8 23 0a 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103a8d:	e8 2e fe ff ff       	call   801038c0 <mycpu>
  p = c->proc;
80103a92:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a98:	e8 53 0a 00 00       	call   801044f0 <popcli>
  if (n > 0)
...
80103aac:	e8 af 2f 00 00       	call   80106a60 <switchuvm>
  return 0;
...
80103aea:	e8 f1 32 00 00       	call   80106de0 <deallocuvm>
...
80103b06:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b09:	e8 a2 09 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103b0e:	e8 ad fd ff ff       	call   801038c0 <mycpu>
  p = c->proc;
80103b13:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b19:	e8 d2 09 00 00       	call   801044f0 <popcli>
  if ((np = allocproc()) == 0)
80103b1e:	e8 ed fa ff ff       	call   80103610 <allocproc>
80103b23:	85 c0                	test   %eax,%eax
80103b25:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103b28:	0f 84 cf 00 00 00    	je     80103bfd <fork+0xfd>
...
80103b45:	0f 84 b9 00 00 00    	je     80103c04 <fork+0x104>
  np->sz = curproc->sz;
...
80103b7c:	e8 6f d2 ff ff       	call   80100df0 <filedup>
...
80103b99:	83 c3 6c             	add    $0x6c,%ebx
  np->cwd = idup(curproc->cwd);
80103b9c:	e8 bf da ff ff       	call   80101660 <idup>
...
80103bb1:	e8 ba 0c 00 00       	call   80104870 <safestrcpy>
  pid = np->pid;
80103bb6:	8b 77 10             	mov    0x10(%edi),%esi
  acquire(&ptable.lock);
80103bb9:	c7 04 24 c0 2d 11 80 	movl   $0x80112dc0,(%esp)
80103bc0:	e8 bb 09 00 00       	call   80104580 <acquire>
  np->state = RUNNABLE;
80103bc5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  proc -> start_tag = ptable.min_start_tag;
80103bcc:	8b 0d f4 4f 11 80    	mov    0x80114ff4,%ecx
80103bd2:	8b 1d f8 4f 11 80    	mov    0x80114ff8,%ebx
80103bd8:	89 8f 80 00 00 00    	mov    %ecx,0x80(%edi)
80103bde:	89 9f 84 00 00 00    	mov    %ebx,0x84(%edi)
  release(&ptable.lock);
80103be4:	c7 04 24 c0 2d 11 80 	movl   $0x80112dc0,(%esp)
80103beb:	e8 50 0a 00 00       	call   80104640 <release>
  return pid;
80103bf0:	83 c4 10             	add    $0x10,%esp
}
80103bf3:	8d 65 f4             	lea    -0xc(%ebp),%esp
80103bf6:	89 f0                	mov    %esi,%eax
80103bf8:	5b                   	pop    %ebx
80103bf9:	5e                   	pop    %esi
80103bfa:	5f                   	pop    %edi
80103bfb:	5d                   	pop    %ebp
80103bfc:	c3                   	ret    
    return -1;
80103bfd:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103c02:	eb ef                	jmp    80103bf3 <fork+0xf3>
    kfree(np->kstack);
80103c04:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103c07:	83 ec 0c             	sub    $0xc,%esp
    return -1;
80103c0a:	be ff ff ff ff       	mov    $0xffffffff,%esi
    kfree(np->kstack);
80103c0f:	ff 73 08             	pushl  0x8(%ebx)
80103c12:	e8 09 e7 ff ff       	call   80102320 <kfree>
    np->kstack = 0;
80103c17:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
80103c1e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103c25:	83 c4 10             	add    $0x10,%esp
80103c28:	eb c9                	jmp    80103bf3 <fork+0xf3>
...
80103c36:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103c39:	e8 82 fc ff ff       	call   801038c0 <mycpu>
80103c3e:	8d 78 04             	lea    0x4(%eax),%edi
80103c41:	89 c3                	mov    %eax,%ebx
  c->proc = 0;
...
80103c54:	31 f6                	xor    %esi,%esi
    acquire(&ptable.lock);
80103c56:	68 c0 2d 11 80       	push   $0x80112dc0
80103c5b:	e8 20 09 00 00       	call   80104580 <acquire>
80103c60:	b8 f4 2d 11 80       	mov    $0x80112df4,%eax
80103c65:	83 c4 10             	add    $0x10,%esp
80103c68:	90                   	nop
80103c69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if (proc_temp -> state != RUNNABLE) { continue; }
80103c70:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103c74:	75 2c                	jne    80103ca2 <scheduler+0x72>
    if (proc_sched == NULL || proc_temp -> start_tag < proc_sched -> start_tag) {
80103c76:	85 f6                	test   %esi,%esi
80103c78:	74 26                	je     80103ca0 <scheduler+0x70>
80103c7a:	8b 8e 84 00 00 00    	mov    0x84(%esi),%ecx
80103c80:	39 88 84 00 00 00    	cmp    %ecx,0x84(%eax)
80103c86:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80103c8c:	7c 12                	jl     80103ca0 <scheduler+0x70>
80103c8e:	7f 12                	jg     80103ca2 <scheduler+0x72>
80103c90:	3b 96 80 00 00 00    	cmp    0x80(%esi),%edx
80103c96:	73 0a                	jae    80103ca2 <scheduler+0x72>
80103c98:	90                   	nop
80103c99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103ca0:	89 c6                	mov    %eax,%esi
80103ca2:	05 88 00 00 00       	add    $0x88,%eax
  for (int i = 0; i < NPROC; ++i) {
80103ca7:	3d f4 4f 11 80       	cmp    $0x80114ff4,%eax
80103cac:	75 c2                	jne    80103c70 <scheduler+0x40>
    if (p != NULL)
80103cae:	85 f6                	test   %esi,%esi
80103cb0:	74 57                	je     80103d09 <scheduler+0xd9>
          if(p->state != RUNNABLE)
80103cb2:	83 7e 0c 03          	cmpl   $0x3,0xc(%esi)
80103cb6:	75 51                	jne    80103d09 <scheduler+0xd9>
          switchuvm(p);
80103cb8:	83 ec 0c             	sub    $0xc,%esp
          c->proc = p;
80103cbb:	89 b3 ac 00 00 00    	mov    %esi,0xac(%ebx)
          switchuvm(p);
80103cc1:	56                   	push   %esi
80103cc2:	e8 99 2d 00 00       	call   80106a60 <switchuvm>
          p->state = RUNNING;
80103cc7:	c7 46 0c 04 00 00 00 	movl   $0x4,0xc(%esi)
          swtch(&(c->scheduler), p->context);
80103cce:	58                   	pop    %eax
80103ccf:	5a                   	pop    %edx
80103cd0:	ff 76 1c             	pushl  0x1c(%esi)
80103cd3:	57                   	push   %edi
80103cd4:	e8 f2 0b 00 00       	call   801048cb <swtch>
          switchkvm();
80103cd9:	e8 62 2d 00 00       	call   80106a40 <switchkvm>
  long long diff = TIME_SLICE / proc -> weight;
80103cde:	b8 80 96 98 00       	mov    $0x989680,%eax
80103ce3:	99                   	cltd   
80103ce4:	f7 7e 7c             	idivl  0x7c(%esi)
80103ce7:	99                   	cltd   
  proc -> start_tag += diff;
80103ce8:	01 86 80 00 00 00    	add    %eax,0x80(%esi)
80103cee:	11 96 84 00 00 00    	adc    %edx,0x84(%esi)
          update_min_start_tag(p);
80103cf4:	89 34 24             	mov    %esi,(%esp)
80103cf7:	e8 f4 fa ff ff       	call   801037f0 <update_min_start_tag>
          c->proc = 0;
80103cfc:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103d03:	00 00 00 
80103d06:	83 c4 10             	add    $0x10,%esp
            release(&ptable.lock);
80103d09:	83 ec 0c             	sub    $0xc,%esp
80103d0c:	68 c0 2d 11 80       	push   $0x80112dc0
80103d11:	e8 2a 09 00 00       	call   80104640 <release>
            continue;
80103d16:	83 c4 10             	add    $0x10,%esp
80103d19:	e9 32 ff ff ff       	jmp    80103c50 <scheduler+0x20>
...
80103d24:	53                   	push   %ebx
  pushcli();
80103d25:	e8 86 07 00 00       	call   801044b0 <pushcli>
  c = mycpu();
...
80103d3d:	68 c0 2d 11 80       	push   $0x80112dc0
...
80103de6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103de9:	e8 c2 06 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103dee:	e8 cd fa ff ff       	call   801038c0 <mycpu>
  p = c->proc;
80103df3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103df9:	e8 f2 06 00 00       	call   801044f0 <popcli>
  if (curproc == initproc)
80103dfe:	39 1d b8 a5 10 80    	cmp    %ebx,0x8010a5b8
80103e04:	8d 73 28             	lea    0x28(%ebx),%esi
80103e07:	8d 7b 68             	lea    0x68(%ebx),%edi
80103e0a:	0f 84 22 01 00 00    	je     80103f32 <exit+0x152>
    if (curproc->ofile[fd])
...
80103e1a:	e8 21 d0 ff ff       	call   80100e40 <fileclose>
      curproc->ofile[fd] = 0;
...
80103e2d:	75 e1                	jne    80103e10 <exit+0x30>
  begin_op();
80103e2f:	e8 7c ed ff ff       	call   80102bb0 <begin_op>
  iput(curproc->cwd);
80103e34:	83 ec 0c             	sub    $0xc,%esp
80103e37:	ff 73 68             	pushl  0x68(%ebx)
80103e3a:	e8 81 d9 ff ff       	call   801017c0 <iput>
  end_op();
80103e3f:	e8 dc ed ff ff       	call   80102c20 <end_op>
  curproc->cwd = 0;
80103e44:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103e4b:	c7 04 24 c0 2d 11 80 	movl   $0x80112dc0,(%esp)
80103e52:	e8 29 07 00 00       	call   80104580 <acquire>
  wakeup1(curproc->parent);
80103e57:	8b 73 14             	mov    0x14(%ebx),%esi
...
static void wakeup1(void *chan)
{
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e5d:	b9 f4 2d 11 80       	mov    $0x80112df4,%ecx
80103e62:	eb 12                	jmp    80103e76 <exit+0x96>
80103e64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e68:	81 c1 88 00 00 00    	add    $0x88,%ecx
80103e6e:	81 f9 f4 4f 11 80    	cmp    $0x80114ff4,%ecx
80103e74:	73 31                	jae    80103ea7 <exit+0xc7>
    if (p->state == SLEEPING && p->chan == chan)
80103e76:	83 79 0c 02          	cmpl   $0x2,0xc(%ecx)
80103e7a:	75 ec                	jne    80103e68 <exit+0x88>
80103e7c:	3b 71 20             	cmp    0x20(%ecx),%esi
80103e7f:	75 e7                	jne    80103e68 <exit+0x88>
    {
      p->state = RUNNABLE;
80103e81:	c7 41 0c 03 00 00 00 	movl   $0x3,0xc(%ecx)
  proc -> start_tag = ptable.min_start_tag;
80103e88:	a1 f4 4f 11 80       	mov    0x80114ff4,%eax
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e8d:	81 c1 88 00 00 00    	add    $0x88,%ecx
  proc -> start_tag = ptable.min_start_tag;
80103e93:	8b 15 f8 4f 11 80    	mov    0x80114ff8,%edx
80103e99:	89 41 f8             	mov    %eax,-0x8(%ecx)
80103e9c:	89 51 fc             	mov    %edx,-0x4(%ecx)
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e9f:	81 f9 f4 4f 11 80    	cmp    $0x80114ff4,%ecx
80103ea5:	72 cf                	jb     80103e76 <exit+0x96>
      p->parent = initproc;
80103ea7:	8b 3d b8 a5 10 80    	mov    0x8010a5b8,%edi
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ead:	be f4 2d 11 80       	mov    $0x80112df4,%esi
80103eb2:	eb 12                	jmp    80103ec6 <exit+0xe6>
80103eb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103eb8:	81 c6 88 00 00 00    	add    $0x88,%esi
80103ebe:	81 fe f4 4f 11 80    	cmp    $0x80114ff4,%esi
80103ec4:	73 53                	jae    80103f19 <exit+0x139>
    if (p->parent == curproc)
80103ec6:	39 5e 14             	cmp    %ebx,0x14(%esi)
80103ec9:	75 ed                	jne    80103eb8 <exit+0xd8>
      if (p->state == ZOMBIE)
80103ecb:	83 7e 0c 05          	cmpl   $0x5,0xc(%esi)
      p->parent = initproc;
80103ecf:	89 7e 14             	mov    %edi,0x14(%esi)
      if (p->state == ZOMBIE)
80103ed2:	75 e4                	jne    80103eb8 <exit+0xd8>
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ed4:	b9 f4 2d 11 80       	mov    $0x80112df4,%ecx
80103ed9:	eb 13                	jmp    80103eee <exit+0x10e>
80103edb:	90                   	nop
80103edc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103ee0:	81 c1 88 00 00 00    	add    $0x88,%ecx
80103ee6:	81 f9 f4 4f 11 80    	cmp    $0x80114ff4,%ecx
80103eec:	73 ca                	jae    80103eb8 <exit+0xd8>
    if (p->state == SLEEPING && p->chan == chan)
80103eee:	83 79 0c 02          	cmpl   $0x2,0xc(%ecx)
80103ef2:	75 ec                	jne    80103ee0 <exit+0x100>
80103ef4:	3b 79 20             	cmp    0x20(%ecx),%edi
80103ef7:	75 e7                	jne    80103ee0 <exit+0x100>
      p->state = RUNNABLE;
80103ef9:	c7 41 0c 03 00 00 00 	movl   $0x3,0xc(%ecx)
  proc -> start_tag = ptable.min_start_tag;
80103f00:	a1 f4 4f 11 80       	mov    0x80114ff4,%eax
80103f05:	8b 15 f8 4f 11 80    	mov    0x80114ff8,%edx
80103f0b:	89 81 80 00 00 00    	mov    %eax,0x80(%ecx)
80103f11:	89 91 84 00 00 00    	mov    %edx,0x84(%ecx)
80103f17:	eb c7                	jmp    80103ee0 <exit+0x100>
  curproc->state = ZOMBIE;
80103f19:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103f20:	e8 fb fd ff ff       	call   80103d20 <sched>
  panic("zombie exit");
80103f25:	83 ec 0c             	sub    $0xc,%esp
80103f28:	68 1d 77 10 80       	push   $0x8010771d
80103f2d:	e8 5e c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103f32:	83 ec 0c             	sub    $0xc,%esp
80103f35:	68 10 77 10 80       	push   $0x80107710
80103f3a:	e8 51 c4 ff ff       	call   80100390 <panic>
80103f3f:	90                   	nop
...
80103f47:	68 c0 2d 11 80       	push   $0x80112dc0
80103f4c:	e8 2f 06 00 00       	call   80104580 <acquire>
  pushcli();
80103f51:	e8 5a 05 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103f56:	e8 65 f9 ff ff       	call   801038c0 <mycpu>
  p = c->proc;
80103f5b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f61:	e8 8a 05 00 00       	call   801044f0 <popcli>
  myproc()->state = RUNNABLE;
80103f66:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103f6d:	e8 ae fd ff ff       	call   80103d20 <sched>
  release(&ptable.lock);
80103f72:	c7 04 24 c0 2d 11 80 	movl   $0x80112dc0,(%esp)
80103f79:	e8 c2 06 00 00       	call   80104640 <release>
}
...
80103f9c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f9f:	e8 0c 05 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103fa4:	e8 17 f9 ff ff       	call   801038c0 <mycpu>
  p = c->proc;
80103fa9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103faf:	e8 3c 05 00 00       	call   801044f0 <popcli>
  if (p == 0)
...
80103fbe:	74 76                	je     80104036 <sleep+0xa6>
  if (lk != &ptable.lock)
80103fc0:	81 fe c0 2d 11 80    	cmp    $0x80112dc0,%esi
80103fc6:	74 50                	je     80104018 <sleep+0x88>
    acquire(&ptable.lock); //DOC: sleeplock1
80103fc8:	83 ec 0c             	sub    $0xc,%esp
80103fcb:	68 c0 2d 11 80       	push   $0x80112dc0
80103fd0:	e8 ab 05 00 00       	call   80104580 <acquire>
    release(lk);
80103fd5:	89 34 24             	mov    %esi,(%esp)
80103fd8:	e8 63 06 00 00       	call   80104640 <release>
  p->chan = chan;
80103fdd:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80103fe0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103fe7:	e8 34 fd ff ff       	call   80103d20 <sched>
  p->chan = 0;
80103fec:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103ff3:	c7 04 24 c0 2d 11 80 	movl   $0x80112dc0,(%esp)
80103ffa:	e8 41 06 00 00       	call   80104640 <release>
    acquire(lk);
...
8010400b:	5d                   	pop    %ebp
    acquire(lk);
8010400c:	e9 6f 05 00 00       	jmp    80104580 <acquire>
...
8010401b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104022:	e8 f9 fc ff ff       	call   80103d20 <sched>
  p->chan = 0;
...
80104039:	68 2f 77 10 80       	push   $0x8010772f
8010403e:	e8 4d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104043:	83 ec 0c             	sub    $0xc,%esp
80104046:	68 29 77 10 80       	push   $0x80107729
...
80104054:	53                   	push   %ebx
  pushcli();
80104055:	e8 56 04 00 00       	call   801044b0 <pushcli>
  c = mycpu();
8010405a:	e8 61 f8 ff ff       	call   801038c0 <mycpu>
  p = c->proc;
8010405f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104065:	e8 86 04 00 00       	call   801044f0 <popcli>
  acquire(&ptable.lock);
8010406a:	83 ec 0c             	sub    $0xc,%esp
8010406d:	68 c0 2d 11 80       	push   $0x80112dc0
80104072:	e8 09 05 00 00       	call   80104580 <acquire>
80104077:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010407a:	31 c0                	xor    %eax,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010407c:	bb f4 2d 11 80       	mov    $0x80112df4,%ebx
80104081:	eb 13                	jmp    80104096 <wait+0x46>
80104083:	90                   	nop
80104084:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104088:	81 c3 88 00 00 00    	add    $0x88,%ebx
8010408e:	81 fb f4 4f 11 80    	cmp    $0x80114ff4,%ebx
80104094:	73 1e                	jae    801040b4 <wait+0x64>
      if (p->parent != curproc)
80104096:	39 73 14             	cmp    %esi,0x14(%ebx)
80104099:	75 ed                	jne    80104088 <wait+0x38>
      if (p->state == ZOMBIE)
8010409b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010409f:	74 37                	je     801040d8 <wait+0x88>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040a1:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
801040a7:	b8 01 00 00 00       	mov    $0x1,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040ac:	81 fb f4 4f 11 80    	cmp    $0x80114ff4,%ebx
801040b2:	72 e2                	jb     80104096 <wait+0x46>
    if (!havekids || curproc->killed)
801040b4:	85 c0                	test   %eax,%eax
801040b6:	74 76                	je     8010412e <wait+0xde>
801040b8:	8b 46 24             	mov    0x24(%esi),%eax
801040bb:	85 c0                	test   %eax,%eax
801040bd:	75 6f                	jne    8010412e <wait+0xde>
    sleep(curproc, &ptable.lock); //DOC: wait-sleep
801040bf:	83 ec 08             	sub    $0x8,%esp
801040c2:	68 c0 2d 11 80       	push   $0x80112dc0
801040c7:	56                   	push   %esi
801040c8:	e8 c3 fe ff ff       	call   80103f90 <sleep>
    havekids = 0;
801040cd:	83 c4 10             	add    $0x10,%esp
801040d0:	eb a8                	jmp    8010407a <wait+0x2a>
801040d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        kfree(p->kstack);
801040d8:	83 ec 0c             	sub    $0xc,%esp
801040db:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
801040de:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
...
801040e7:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
801040ea:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040f1:	e8 1a 2d 00 00       	call   80106e10 <freevm>
        release(&ptable.lock);
801040f6:	c7 04 24 c0 2d 11 80 	movl   $0x80112dc0,(%esp)
        p->pid = 0;
801040fd:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104104:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
8010410b:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
8010410f:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80104116:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010411d:	e8 1e 05 00 00       	call   80104640 <release>
        return pid;
80104122:	83 c4 10             	add    $0x10,%esp
}
80104125:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104128:	89 f0                	mov    %esi,%eax
8010412a:	5b                   	pop    %ebx
8010412b:	5e                   	pop    %esi
8010412c:	5d                   	pop    %ebp
8010412d:	c3                   	ret    
...
8010412e:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104131:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104136:	68 c0 2d 11 80       	push   $0x80112dc0
8010413b:	e8 00 05 00 00       	call   80104640 <release>
      return -1;
80104140:	83 c4 10             	add    $0x10,%esp
80104143:	eb e0                	jmp    80104125 <wait+0xd5>
...
80104157:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010415a:	68 c0 2d 11 80       	push   $0x80112dc0
8010415f:	e8 1c 04 00 00       	call   80104580 <acquire>
80104164:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104167:	b9 f4 2d 11 80       	mov    $0x80112df4,%ecx
8010416c:	eb 10                	jmp    8010417e <wakeup+0x2e>
8010416e:	66 90                	xchg   %ax,%ax
80104170:	81 c1 88 00 00 00    	add    $0x88,%ecx
80104176:	81 f9 f4 4f 11 80    	cmp    $0x80114ff4,%ecx
8010417c:	73 31                	jae    801041af <wakeup+0x5f>
    if (p->state == SLEEPING && p->chan == chan)
8010417e:	83 79 0c 02          	cmpl   $0x2,0xc(%ecx)
80104182:	75 ec                	jne    80104170 <wakeup+0x20>
80104184:	3b 59 20             	cmp    0x20(%ecx),%ebx
80104187:	75 e7                	jne    80104170 <wakeup+0x20>
      p->state = RUNNABLE;
80104189:	c7 41 0c 03 00 00 00 	movl   $0x3,0xc(%ecx)
  proc -> start_tag = ptable.min_start_tag;
80104190:	a1 f4 4f 11 80       	mov    0x80114ff4,%eax
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104195:	81 c1 88 00 00 00    	add    $0x88,%ecx
  proc -> start_tag = ptable.min_start_tag;
8010419b:	8b 15 f8 4f 11 80    	mov    0x80114ff8,%edx
801041a1:	89 41 f8             	mov    %eax,-0x8(%ecx)
801041a4:	89 51 fc             	mov    %edx,-0x4(%ecx)
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041a7:	81 f9 f4 4f 11 80    	cmp    $0x80114ff4,%ecx
801041ad:	72 cf                	jb     8010417e <wakeup+0x2e>
  wakeup1(chan);
  release(&ptable.lock);
801041af:	c7 45 08 c0 2d 11 80 	movl   $0x80112dc0,0x8(%ebp)
}
801041b6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801041b9:	c9                   	leave  
  release(&ptable.lock);
801041ba:	e9 81 04 00 00       	jmp    80104640 <release>
801041bf:	90                   	nop
...
801041c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801041ca:	68 c0 2d 11 80       	push   $0x80112dc0
801041cf:	e8 ac 03 00 00       	call   80104580 <acquire>
801041d4:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041d7:	b8 f4 2d 11 80       	mov    $0x80112df4,%eax
801041dc:	eb 0e                	jmp    801041ec <kill+0x2c>
801041de:	66 90                	xchg   %ax,%ax
801041e0:	05 88 00 00 00       	add    $0x88,%eax
801041e5:	3d f4 4f 11 80       	cmp    $0x80114ff4,%eax
...
80104208:	68 c0 2d 11 80       	push   $0x80112dc0
8010420d:	e8 2e 04 00 00       	call   80104640 <release>
      return 0;
...
80104223:	68 c0 2d 11 80       	push   $0x80112dc0
80104228:	e8 13 04 00 00       	call   80104640 <release>
  return -1;
...
80104246:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104249:	bb f4 2d 11 80       	mov    $0x80112df4,%ebx
{
...
80104281:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104284:	ba 40 77 10 80       	mov    $0x80107740,%edx
    if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104289:	77 11                	ja     8010429c <procdump+0x5c>
8010428b:	8b 14 85 a0 77 10 80 	mov    -0x7fef8860(,%eax,4),%edx
      state = "???";
80104292:	b8 40 77 10 80       	mov    $0x80107740,%eax
...
801042a4:	68 44 77 10 80       	push   $0x80107744
...
801042cb:	e8 90 01 00 00       	call   80104460 <getcallerpcs>
...
801042e9:	68 81 71 10 80       	push   $0x80107181
...
8010431a:	68 b8 77 10 80       	push   $0x801077b8
...
8010435f:	e8 1c 02 00 00       	call   80104580 <acquire>
  while (lk->locked) {
...
80104375:	e8 16 fc ff ff       	call   80103f90 <sleep>
  while (lk->locked) {
...
80104383:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104389:	e8 d2 f5 ff ff       	call   80103960 <myproc>
...
801043d4:	e8 77 fd ff ff       	call   80104150 <wakeup>
  release(&lk->lk);
...
80104402:	e8 79 01 00 00       	call   80104580 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104407:	8b 03                	mov    (%ebx),%eax
80104409:	83 c4 10             	add    $0x10,%esp
8010440c:	85 c0                	test   %eax,%eax
8010440e:	74 13                	je     80104423 <holdingsleep+0x33>
80104410:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80104413:	e8 48 f5 ff ff       	call   80103960 <myproc>
...
80104427:	e8 14 02 00 00       	call   80104640 <release>
  return r;
}
...
801044b9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801044ba:	e8 01 f4 ff ff       	call   801038c0 <mycpu>
801044bf:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801044c5:	85 c0                	test   %eax,%eax
801044c7:	75 11                	jne    801044da <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
801044c9:	81 e3 00 02 00 00    	and    $0x200,%ebx
801044cf:	e8 ec f3 ff ff       	call   801038c0 <mycpu>
801044d4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801044da:	e8 e1 f3 ff ff       	call   801038c0 <mycpu>
801044df:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
8010451c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104520:	e8 9b f3 ff ff       	call   801038c0 <mycpu>
...
80104535:	68 c3 77 10 80       	push   $0x801077c3
8010453a:	e8 51 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010453f:	83 ec 0c             	sub    $0xc,%esp
80104542:	68 da 77 10 80       	push   $0x801077da
80104547:	e8 44 be ff ff       	call   80100390 <panic>
...
80104558:	31 db                	xor    %ebx,%ebx
  pushcli();
8010455a:	e8 51 ff ff ff       	call   801044b0 <pushcli>
...
80104568:	e8 53 f3 ff ff       	call   801038c0 <mycpu>
8010456d:	39 c3                	cmp    %eax,%ebx
8010456f:	0f 94 c3             	sete   %bl
80104572:	0f b6 db             	movzbl %bl,%ebx
  popcli();
80104575:	e8 76 ff ff ff       	call   801044f0 <popcli>
}
...
80104585:	e8 26 ff ff ff       	call   801044b0 <pushcli>
  if(holding(lk))
8010458a:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010458d:	83 ec 0c             	sub    $0xc,%esp
80104590:	53                   	push   %ebx
80104591:	e8 ba ff ff ff       	call   80104550 <holding>
80104596:	83 c4 10             	add    $0x10,%esp
80104599:	85 c0                	test   %eax,%eax
8010459b:	0f 85 83 00 00 00    	jne    80104624 <acquire+0xa4>
...
801045c4:	e8 f7 f2 ff ff       	call   801038c0 <mycpu>
  getcallerpcs(&lk, lk->pcs);
801045c9:	8d 53 0c             	lea    0xc(%ebx),%edx
  lk->cpu = mycpu();
801045cc:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
801045cf:	89 e8                	mov    %ebp,%eax
801045d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801045d8:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
801045de:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
801045e4:	77 1a                	ja     80104600 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
801045e6:	8b 48 04             	mov    0x4(%eax),%ecx
801045e9:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
  for(i = 0; i < 10; i++){
801045ec:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
801045ef:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801045f1:	83 fe 0a             	cmp    $0xa,%esi
...
80104600:	8d 04 b2             	lea    (%edx,%esi,4),%eax
80104603:	83 c2 28             	add    $0x28,%edx
...
80104627:	68 e1 77 10 80       	push   $0x801077e1
...
8010464b:	e8 00 ff ff ff       	call   80104550 <holding>
80104650:	83 c4 10             	add    $0x10,%esp
80104653:	85 c0                	test   %eax,%eax
80104655:	74 22                	je     80104679 <release+0x39>
  lk->pcs[0] = 0;
80104657:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
8010465e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104665:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010466a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80104670:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104673:	c9                   	leave  
  popcli();
80104674:	e9 77 fe ff ff       	jmp    801044f0 <popcli>
    panic("release");
80104679:	83 ec 0c             	sub    $0xc,%esp
8010467c:	68 e9 77 10 80       	push   $0x801077e9
80104681:	e8 0a bd ff ff       	call   80100390 <panic>
...
801048e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801048ea:	e8 71 f0 ff ff       	call   80103960 <myproc>
...
80104927:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010492a:	e8 31 f0 ff ff       	call   80103960 <myproc>
...
80104995:	e8 c6 ef ff ff       	call   80103960 <myproc>
...
801049a3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049a6:	e8 b5 ef ff ff       	call   80103960 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801049e8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049eb:	e8 70 ef ff ff       	call   80103960 <myproc>
...
80104a84:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a87:	e8 d4 ee ff ff       	call   80103960 <myproc>
...
80104a97:	83 fa 15             	cmp    $0x15,%edx
80104a9a:	77 1c                	ja     80104ab8 <syscall+0x38>
80104a9c:	8b 14 85 20 78 10 80 	mov    -0x7fef87e0(,%eax,4),%edx
...
80104ac0:	68 f1 77 10 80       	push   $0x801077f1
...
80104c45:	68 8b 78 10 80       	push   $0x8010788b
...
80104c5a:	68 9a 78 10 80       	push   $0x8010789a
80104c5f:	e8 2c b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c64:	83 ec 0c             	sub    $0xc,%esp
80104c67:	68 7c 78 10 80       	push   $0x8010787c
...
80104ce9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104ceb:	e8 70 ec ff ff       	call   80103960 <myproc>
...
80104e33:	78 2b                	js     80104e60 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e35:	e8 26 eb ff ff       	call   80103960 <myproc>
...
80104ef2:	0f 88 e2 00 00 00    	js     80104fda <sys_link+0x11a>
  begin_op();
80104ef8:	e8 b3 dc ff ff       	call   80102bb0 <begin_op>
  if((ip = namei(old)) == 0){
...
80104fcd:	e8 4e c9 ff ff       	call   80101920 <iunlockput>
  end_op();
80104fd2:	e8 49 dc ff ff       	call   80102c20 <end_op>
  return -1;
...
80104ffd:	eb 9b                	jmp    80104f9a <sys_link+0xda>
    end_op();
80104fff:	e8 1c dc ff ff       	call   80102c20 <end_op>
    return -1;
...
8010502f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80105032:	e8 79 db ff ff       	call   80102bb0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80105059:	58                   	pop    %eax
8010505a:	5a                   	pop    %edx
8010505b:	68 98 78 10 80       	push   $0x80107898
...
80105074:	68 97 78 10 80       	push   $0x80107897
...
80105112:	e8 09 c8 ff ff       	call   80101920 <iunlockput>
  end_op();
80105117:	e8 04 db ff ff       	call   80102c20 <end_op>
  return 0;
...
80105222:	0f 88 04 01 00 00    	js     8010532c <sys_open+0x13c>
  ...
  begin_op();
80105228:	e8 83 d9 ff ff       	call   80102bb0 <begin_op>
...
8010526f:	0f 84 a6 00 00 00    	je     8010531b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105275:	e8 e6 e6 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010531f:	e8 fc c5 ff ff       	call   80101920 <iunlockput>
    end_op();
80105324:	e8 f7 d8 ff ff       	call   80102c20 <end_op>
    return -1;
...
8010541e:	e8 fd c4 ff ff       	call   80101920 <iunlockput>
  end_op();
80105423:	e8 f8 d7 ff ff       	call   80102c20 <end_op>
  return 0;
...
80105445:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105448:	e8 13 e5 ff ff       	call   80103960 <myproc>
8010544d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010544f:	e8 5c d7 ff ff       	call   80102bb0 <begin_op>
...
8010549d:	e8 1e c3 ff ff       	call   801017c0 <iput>
  end_op();
801054a2:	e8 79 d7 ff ff       	call   80102c20 <end_op>
  curproc->cwd = ip;
...
801054c4:	e8 57 c4 ff ff       	call   80101920 <iunlockput>
    end_op();
801054c9:	e8 52 d7 ff ff       	call   80102c20 <end_op>
    return -1;
...
8010560c:	e8 3f dc ff ff       	call   80103250 <pipealloc>
...
8010561f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105621:	e8 3a e3 ff ff       	call   80103960 <myproc>
...
801056c3:	5d                   	pop    %ebp
  return fork();
801056c4:	e9 37 e4 ff ff       	jmp    80103b00 <fork>
...
801056d3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056d6:	e8 05 e7 ff ff       	call   80103de0 <exit>
...
801056e3:	5d                   	pop    %ebp
  return wait();
801056e4:	e9 67 e9 ff ff       	jmp    80104050 <wait>
...
8010570e:	e8 ad ea ff ff       	call   801041c0 <kill>
...
80105733:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105736:	e8 25 e2 ff ff       	call   80103960 <myproc>
...
80105766:	e8 15 e3 ff ff       	call   80103a80 <growproc>
...
801057b0:	68 00 50 11 80       	push   $0x80115000
801057b5:	e8 c6 ed ff ff       	call   80104580 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ba:	8b 55 f4             	mov    -0xc(%ebp),%edx
801057bd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801057c0:	8b 1d 40 58 11 80    	mov    0x80115840,%ebx
  while(ticks - ticks0 < n){
...
801057d3:	68 00 50 11 80       	push   $0x80115000
801057d8:	68 40 58 11 80       	push   $0x80115840
801057dd:	e8 ae e7 ff ff       	call   80103f90 <sleep>
  while(ticks - ticks0 < n){
801057e2:	a1 40 58 11 80       	mov    0x80115840,%eax
...
80105800:	68 00 50 11 80       	push   $0x80115000
80105805:	e8 36 ee ff ff       	call   80104640 <release>
      return -1;
...
80105823:	68 00 50 11 80       	push   $0x80115000
80105828:	e8 13 ee ff ff       	call   80104640 <release>
  return 0;
...
80105844:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105847:	68 00 50 11 80       	push   $0x80115000
8010584c:	e8 2f ed ff ff       	call   80104580 <acquire>
  xticks = ticks;
80105851:	8b 1d 40 58 11 80    	mov    0x80115840,%ebx
  release(&tickslock);
80105857:	c7 04 24 00 50 11 80 	movl   $0x80115000,(%esp)
8010585e:	e8 dd ed ff ff       	call   80104640 <release>
  return xticks;
}
...
8010587c:	e8 0f f1 ff ff       	call   80104990 <argint>
80105881:	83 c4 10             	add    $0x10,%esp
80105884:	85 c0                	test   %eax,%eax
80105886:	78 18                	js     801058a0 <sys_sfq+0x30>
    return -1;
...
80105890:	89 50 7c             	mov    %edx,0x7c(%eax)
  return weight;
80105893:	89 d0                	mov    %edx,%eax
80105895:	c9                   	leave  
80105896:	c3                   	ret    
80105897:	89 f6                	mov    %esi,%esi
80105899:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    return -1;
801058a0:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801058a5:	eb ec                	jmp    80105893 <sys_sfq+0x23>
...
801058e7:	c7 04 c5 42 50 11 80 	movl   $0x8e000008,-0x7feeafbe(,%eax,8)
801058ee:	08 00 00 8e 
801058f2:	66 89 14 c5 40 50 11 	mov    %dx,-0x7feeafc0(,%eax,8)
801058f9:	80 
801058fa:	c1 ea 10             	shr    $0x10,%edx
801058fd:	66 89 14 c5 46 50 11 	mov    %dx,-0x7feeafba(,%eax,8)
80105904:	80 
  for(i = 0; i < 256; i++)
...
8010590f:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105914:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105917:	c7 05 42 52 11 80 08 	movl   $0xef000008,0x80115242
8010591e:	00 00 ef 
  initlock(&tickslock, "time");
80105921:	68 dd 78 10 80       	push   $0x801078dd
80105926:	68 00 50 11 80       	push   $0x80115000
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010592b:	66 a3 40 52 11 80    	mov    %ax,0x80115240
80105931:	c1 e8 10             	shr    $0x10,%eax
80105934:	66 a3 46 52 11 80    	mov    %ax,0x80115246
  initlock(&tickslock, "time");
8010593a:	e8 01 eb ff ff       	call   80104440 <initlock>
}
8010593f:	83 c4 10             	add    $0x10,%esp
80105942:	c9                   	leave  
80105943:	c3                   	ret    
80105944:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010594a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
8010595b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010595f:	b8 40 50 11 80       	mov    $0x80115040,%eax
...
80105992:	0f 84 f0 00 00 00    	je     80105a88 <trap+0x108>
    if(myproc()->killed)
      exit();
    return;
  }
...
801059a0:	ff 24 85 84 79 10 80 	jmp    *-0x7fef867c(,%eax,4)
...
801059ba:	0f 84 14 02 00 00    	je     80105bd4 <trap+0x254>
801059c0:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
801059c4:	0f 84 0a 02 00 00    	je     80105bd4 <trap+0x254>
...
801059d5:	89 45 dc             	mov    %eax,-0x24(%ebp)
801059d8:	8b 47 34             	mov    0x34(%edi),%eax
801059db:	8b 77 30             	mov    0x30(%edi),%esi
...
80105a05:	68 40 79 10 80       	push   $0x80107940
...
80105a27:	e8 34 df ff ff       	call   80103960 <myproc>
...
80105a3e:	0f 84 4c 01 00 00    	je     80105b90 <trap+0x210>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105a44:	e8 17 df ff ff       	call   80103960 <myproc>
...
80105a56:	74 68                	je     80105ac0 <trap+0x140>
...
80105a8d:	8b 58 24             	mov    0x24(%eax),%ebx
80105a90:	85 db                	test   %ebx,%ebx
80105a92:	0f 85 e8 00 00 00    	jne    80105b80 <trap+0x200>
    myproc()->tf = tf;
80105a98:	e8 c3 de ff ff       	call   80103960 <myproc>
80105a9d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105aa0:	e8 db ef ff ff       	call   80104a80 <syscall>
    if(myproc()->killed)
80105aa5:	e8 b6 de ff ff       	call   80103960 <myproc>
80105aaa:	8b 48 24             	mov    0x24(%eax),%ecx
80105aad:	85 c9                	test   %ecx,%ecx
80105aaf:	74 c9                	je     80105a7a <trap+0xfa>
}
...
80105ab7:	5d                   	pop    %ebp
      exit();
80105ab8:	e9 23 e3 ff ff       	jmp    80103de0 <exit>
80105abd:	8d 76 00             	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105ac0:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
80105ac4:	75 92                	jne    80105a58 <trap+0xd8>
    yield();
80105ac6:	e8 75 e4 ff ff       	call   80103f40 <yield>
80105acb:	eb 8b                	jmp    80105a58 <trap+0xd8>
80105acd:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105ad0:	e8 6b de ff ff       	call   80103940 <cpuid>
80105ad5:	85 c0                	test   %eax,%eax
80105ad7:	0f 84 c3 00 00 00    	je     80105ba0 <trap+0x220>
    lapiceoi();
80105add:	e8 7e cc ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ae2:	e8 79 de ff ff       	call   80103960 <myproc>
80105ae7:	85 c0                	test   %eax,%eax
80105ae9:	0f 85 38 ff ff ff    	jne    80105a27 <trap+0xa7>
80105aef:	e9 50 ff ff ff       	jmp    80105a44 <trap+0xc4>
80105af4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105af8:	e8 23 cb ff ff       	call   80102620 <kbdintr>
    lapiceoi();
80105afd:	e8 5e cc ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b02:	e8 59 de ff ff       	call   80103960 <myproc>
80105b07:	85 c0                	test   %eax,%eax
80105b09:	0f 85 18 ff ff ff    	jne    80105a27 <trap+0xa7>
80105b0f:	e9 30 ff ff ff       	jmp    80105a44 <trap+0xc4>
80105b14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b18:	e8 53 02 00 00       	call   80105d70 <uartintr>
    lapiceoi();
80105b1d:	e8 3e cc ff ff       	call   80102760 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b22:	e8 39 de ff ff       	call   80103960 <myproc>
80105b27:	85 c0                	test   %eax,%eax
80105b29:	0f 85 f8 fe ff ff    	jne    80105a27 <trap+0xa7>
80105b2f:	e9 10 ff ff ff       	jmp    80105a44 <trap+0xc4>
80105b34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105b38:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105b3c:	8b 77 38             	mov    0x38(%edi),%esi
80105b3f:	e8 fc dd ff ff       	call   80103940 <cpuid>
80105b44:	56                   	push   %esi
80105b45:	53                   	push   %ebx
80105b46:	50                   	push   %eax
80105b47:	68 e8 78 10 80       	push   $0x801078e8
80105b4c:	e8 0f ab ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105b51:	e8 0a cc ff ff       	call   80102760 <lapiceoi>
    break;
80105b56:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b59:	e8 02 de ff ff       	call   80103960 <myproc>
80105b5e:	85 c0                	test   %eax,%eax
80105b60:	0f 85 c1 fe ff ff    	jne    80105a27 <trap+0xa7>
80105b66:	e9 d9 fe ff ff       	jmp    80105a44 <trap+0xc4>
80105b6b:	90                   	nop
80105b6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105b70:	e8 1b c5 ff ff       	call   80102090 <ideintr>
80105b75:	e9 63 ff ff ff       	jmp    80105add <trap+0x15d>
80105b7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105b80:	e8 5b e2 ff ff       	call   80103de0 <exit>
80105b85:	e9 0e ff ff ff       	jmp    80105a98 <trap+0x118>
80105b8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105b90:	e8 4b e2 ff ff       	call   80103de0 <exit>
80105b95:	e9 aa fe ff ff       	jmp    80105a44 <trap+0xc4>
80105b9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105ba0:	83 ec 0c             	sub    $0xc,%esp
80105ba3:	68 00 50 11 80       	push   $0x80115000
80105ba8:	e8 d3 e9 ff ff       	call   80104580 <acquire>
      wakeup(&ticks);
80105bad:	c7 04 24 40 58 11 80 	movl   $0x80115840,(%esp)
      ticks++;
80105bb4:	83 05 40 58 11 80 01 	addl   $0x1,0x80115840
      wakeup(&ticks);
80105bbb:	e8 90 e5 ff ff       	call   80104150 <wakeup>
      release(&tickslock);
80105bc0:	c7 04 24 00 50 11 80 	movl   $0x80115000,(%esp)
80105bc7:	e8 74 ea ff ff       	call   80104640 <release>
80105bcc:	83 c4 10             	add    $0x10,%esp
80105bcf:	e9 09 ff ff ff       	jmp    80105add <trap+0x15d>
80105bd4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
...
80105be2:	ff 77 30             	pushl  0x30(%edi)
80105be5:	68 0c 79 10 80       	push   $0x8010790c
80105bea:	e8 71 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105bef:	83 c4 14             	add    $0x14,%esp
80105bf2:	68 e2 78 10 80       	push   $0x801078e2
80105bf7:	e8 94 a7 ff ff       	call   80100390 <panic>
...
80105c55:	e8 26 cb ff ff       	call   80102780 <microdelay>
...
80105cec:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105cef:	bb 04 7a 10 80       	mov    $0x80107a04,%ebx
  ioapicenable(IRQ_COM1, 0);
80105cf4:	6a 00                	push   $0x0
80105cf6:	6a 04                	push   $0x4
80105cf8:	e8 e3 c5 ff ff       	call   801022e0 <ioapicenable>
80105cfd:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105d00:	b8 78 00 00 00       	mov    $0x78,%eax
80105d05:	eb 13                	jmp    80105d1a <uartinit+0x9a>
...
80105d18:	74 19                	je     80105d33 <uartinit+0xb3>
  if(!uart)
80105d1a:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
...
80105d40 <uartputc>:
  if(!uart)
80105d40:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
{
...
80105d7b:	e8 90 aa ff ff       	call   80100810 <consoleintr>
}
...
80105d87:	6a 00                	push   $0x0
  jmp alltraps
80105d89:	e9 19 fb ff ff       	jmp    801058a7 <alltraps>
...
80105d90:	6a 01                	push   $0x1
  jmp alltraps
80105d92:	e9 10 fb ff ff       	jmp    801058a7 <alltraps>
...
80105d99:	6a 02                	push   $0x2
  jmp alltraps
80105d9b:	e9 07 fb ff ff       	jmp    801058a7 <alltraps>
...
80105da2:	6a 03                	push   $0x3
  jmp alltraps
80105da4:	e9 fe fa ff ff       	jmp    801058a7 <alltraps>
...
80105dab:	6a 04                	push   $0x4
  jmp alltraps
80105dad:	e9 f5 fa ff ff       	jmp    801058a7 <alltraps>
...
80105db4:	6a 05                	push   $0x5
  jmp alltraps
80105db6:	e9 ec fa ff ff       	jmp    801058a7 <alltraps>
...
80105dbd:	6a 06                	push   $0x6
  jmp alltraps
80105dbf:	e9 e3 fa ff ff       	jmp    801058a7 <alltraps>
...
80105de4:	6a 0b                	push   $0xb
  jmp alltraps
80105de6:	e9 bc fa ff ff       	jmp    801058a7 <alltraps>
...
80105deb:	6a 0c                	push   $0xc
  jmp alltraps
80105ded:	e9 b5 fa ff ff       	jmp    801058a7 <alltraps>
...
80105df2:	6a 0d                	push   $0xd
  jmp alltraps
80105df4:	e9 ae fa ff ff       	jmp    801058a7 <alltraps>
...
80105df9:	6a 0e                	push   $0xe
  jmp alltraps
80105dfb:	e9 a7 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e0b:	6a 10                	push   $0x10
  jmp alltraps
80105e0d:	e9 95 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e24:	6a 13                	push   $0x13
  jmp alltraps
80105e26:	e9 7c fa ff ff       	jmp    801058a7 <alltraps>
...
80105e2d:	6a 14                	push   $0x14
  jmp alltraps
80105e2f:	e9 73 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e36:	6a 15                	push   $0x15
  jmp alltraps
80105e38:	e9 6a fa ff ff       	jmp    801058a7 <alltraps>
...
80105e3f:	6a 16                	push   $0x16
  jmp alltraps
80105e41:	e9 61 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e48:	6a 17                	push   $0x17
  jmp alltraps
80105e4a:	e9 58 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e51:	6a 18                	push   $0x18
  jmp alltraps
80105e53:	e9 4f fa ff ff       	jmp    801058a7 <alltraps>
...
80105e5a:	6a 19                	push   $0x19
  jmp alltraps
80105e5c:	e9 46 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e63:	6a 1a                	push   $0x1a
  jmp alltraps
80105e65:	e9 3d fa ff ff       	jmp    801058a7 <alltraps>
...
80105e6c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e6e:	e9 34 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e75:	6a 1c                	push   $0x1c
  jmp alltraps
80105e77:	e9 2b fa ff ff       	jmp    801058a7 <alltraps>
...
80105e7e:	6a 1d                	push   $0x1d
  jmp alltraps
80105e80:	e9 22 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e87:	6a 1e                	push   $0x1e
  jmp alltraps
80105e89:	e9 19 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e90:	6a 1f                	push   $0x1f
  jmp alltraps
80105e92:	e9 10 fa ff ff       	jmp    801058a7 <alltraps>
...
80105e99:	6a 20                	push   $0x20
  jmp alltraps
80105e9b:	e9 07 fa ff ff       	jmp    801058a7 <alltraps>
...
80105ea2:	6a 21                	push   $0x21
  jmp alltraps
80105ea4:	e9 fe f9 ff ff       	jmp    801058a7 <alltraps>
...
80105eab:	6a 22                	push   $0x22
  jmp alltraps
80105ead:	e9 f5 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105eb4:	6a 23                	push   $0x23
  jmp alltraps
80105eb6:	e9 ec f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ebd:	6a 24                	push   $0x24
  jmp alltraps
80105ebf:	e9 e3 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ec6:	6a 25                	push   $0x25
  jmp alltraps
80105ec8:	e9 da f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ecf:	6a 26                	push   $0x26
  jmp alltraps
80105ed1:	e9 d1 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ed8:	6a 27                	push   $0x27
  jmp alltraps
80105eda:	e9 c8 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ee1:	6a 28                	push   $0x28
  jmp alltraps
80105ee3:	e9 bf f9 ff ff       	jmp    801058a7 <alltraps>
...
80105eea:	6a 29                	push   $0x29
  jmp alltraps
80105eec:	e9 b6 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105ef3:	6a 2a                	push   $0x2a
  jmp alltraps
80105ef5:	e9 ad f9 ff ff       	jmp    801058a7 <alltraps>
...
80105efc:	6a 2b                	push   $0x2b
  jmp alltraps
80105efe:	e9 a4 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f05:	6a 2c                	push   $0x2c
  jmp alltraps
80105f07:	e9 9b f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f0e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f10:	e9 92 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f17:	6a 2e                	push   $0x2e
  jmp alltraps
80105f19:	e9 89 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f20:	6a 2f                	push   $0x2f
  jmp alltraps
80105f22:	e9 80 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f29:	6a 30                	push   $0x30
  jmp alltraps
80105f2b:	e9 77 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f32:	6a 31                	push   $0x31
  jmp alltraps
80105f34:	e9 6e f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f3b:	6a 32                	push   $0x32
  jmp alltraps
80105f3d:	e9 65 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f44:	6a 33                	push   $0x33
  jmp alltraps
80105f46:	e9 5c f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f4d:	6a 34                	push   $0x34
  jmp alltraps
80105f4f:	e9 53 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f56:	6a 35                	push   $0x35
  jmp alltraps
80105f58:	e9 4a f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f5f:	6a 36                	push   $0x36
  jmp alltraps
80105f61:	e9 41 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f68:	6a 37                	push   $0x37
  jmp alltraps
80105f6a:	e9 38 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f71:	6a 38                	push   $0x38
  jmp alltraps
80105f73:	e9 2f f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f7a:	6a 39                	push   $0x39
  jmp alltraps
80105f7c:	e9 26 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f83:	6a 3a                	push   $0x3a
  jmp alltraps
80105f85:	e9 1d f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f8c:	6a 3b                	push   $0x3b
  jmp alltraps
80105f8e:	e9 14 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f95:	6a 3c                	push   $0x3c
  jmp alltraps
80105f97:	e9 0b f9 ff ff       	jmp    801058a7 <alltraps>
...
80105f9e:	6a 3d                	push   $0x3d
  jmp alltraps
80105fa0:	e9 02 f9 ff ff       	jmp    801058a7 <alltraps>
...
80105fa7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fa9:	e9 f9 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fb0:	6a 3f                	push   $0x3f
  jmp alltraps
80105fb2:	e9 f0 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fb9:	6a 40                	push   $0x40
  jmp alltraps
80105fbb:	e9 e7 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fc2:	6a 41                	push   $0x41
  jmp alltraps
80105fc4:	e9 de f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fcb:	6a 42                	push   $0x42
  jmp alltraps
80105fcd:	e9 d5 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fd4:	6a 43                	push   $0x43
  jmp alltraps
80105fd6:	e9 cc f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fdd:	6a 44                	push   $0x44
  jmp alltraps
80105fdf:	e9 c3 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fe6:	6a 45                	push   $0x45
  jmp alltraps
80105fe8:	e9 ba f8 ff ff       	jmp    801058a7 <alltraps>
...
80105fef:	6a 46                	push   $0x46
  jmp alltraps
80105ff1:	e9 b1 f8 ff ff       	jmp    801058a7 <alltraps>
...
80105ff8:	6a 47                	push   $0x47
  jmp alltraps
80105ffa:	e9 a8 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106001:	6a 48                	push   $0x48
  jmp alltraps
80106003:	e9 9f f8 ff ff       	jmp    801058a7 <alltraps>
...
8010600a:	6a 49                	push   $0x49
  jmp alltraps
8010600c:	e9 96 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106013:	6a 4a                	push   $0x4a
  jmp alltraps
80106015:	e9 8d f8 ff ff       	jmp    801058a7 <alltraps>
...
8010601c:	6a 4b                	push   $0x4b
  jmp alltraps
8010601e:	e9 84 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106025:	6a 4c                	push   $0x4c
  jmp alltraps
80106027:	e9 7b f8 ff ff       	jmp    801058a7 <alltraps>
...
8010602e:	6a 4d                	push   $0x4d
  jmp alltraps
80106030:	e9 72 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106037:	6a 4e                	push   $0x4e
  jmp alltraps
80106039:	e9 69 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106040:	6a 4f                	push   $0x4f
  jmp alltraps
80106042:	e9 60 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106049:	6a 50                	push   $0x50
  jmp alltraps
8010604b:	e9 57 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106052:	6a 51                	push   $0x51
  jmp alltraps
80106054:	e9 4e f8 ff ff       	jmp    801058a7 <alltraps>
...
8010605b:	6a 52                	push   $0x52
  jmp alltraps
8010605d:	e9 45 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106064:	6a 53                	push   $0x53
  jmp alltraps
80106066:	e9 3c f8 ff ff       	jmp    801058a7 <alltraps>
...
8010606d:	6a 54                	push   $0x54
  jmp alltraps
8010606f:	e9 33 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106076:	6a 55                	push   $0x55
  jmp alltraps
80106078:	e9 2a f8 ff ff       	jmp    801058a7 <alltraps>
...
8010607f:	6a 56                	push   $0x56
  jmp alltraps
80106081:	e9 21 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106088:	6a 57                	push   $0x57
  jmp alltraps
8010608a:	e9 18 f8 ff ff       	jmp    801058a7 <alltraps>
...
80106091:	6a 58                	push   $0x58
  jmp alltraps
80106093:	e9 0f f8 ff ff       	jmp    801058a7 <alltraps>
...
8010609a:	6a 59                	push   $0x59
  jmp alltraps
8010609c:	e9 06 f8 ff ff       	jmp    801058a7 <alltraps>
...
801060a3:	6a 5a                	push   $0x5a
  jmp alltraps
801060a5:	e9 fd f7 ff ff       	jmp    801058a7 <alltraps>
...
801060ac:	6a 5b                	push   $0x5b
  jmp alltraps
801060ae:	e9 f4 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060b5:	6a 5c                	push   $0x5c
  jmp alltraps
801060b7:	e9 eb f7 ff ff       	jmp    801058a7 <alltraps>
...
801060be:	6a 5d                	push   $0x5d
  jmp alltraps
801060c0:	e9 e2 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060c7:	6a 5e                	push   $0x5e
  jmp alltraps
801060c9:	e9 d9 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060d0:	6a 5f                	push   $0x5f
  jmp alltraps
801060d2:	e9 d0 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060d9:	6a 60                	push   $0x60
  jmp alltraps
801060db:	e9 c7 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060e2:	6a 61                	push   $0x61
  jmp alltraps
801060e4:	e9 be f7 ff ff       	jmp    801058a7 <alltraps>
...
801060eb:	6a 62                	push   $0x62
  jmp alltraps
801060ed:	e9 b5 f7 ff ff       	jmp    801058a7 <alltraps>
...
801060f4:	6a 63                	push   $0x63
  jmp alltraps
801060f6:	e9 ac f7 ff ff       	jmp    801058a7 <alltraps>
...
801060fd:	6a 64                	push   $0x64
  jmp alltraps
801060ff:	e9 a3 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106106:	6a 65                	push   $0x65
  jmp alltraps
80106108:	e9 9a f7 ff ff       	jmp    801058a7 <alltraps>
...
8010610f:	6a 66                	push   $0x66
  jmp alltraps
80106111:	e9 91 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106118:	6a 67                	push   $0x67
  jmp alltraps
8010611a:	e9 88 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106121:	6a 68                	push   $0x68
  jmp alltraps
80106123:	e9 7f f7 ff ff       	jmp    801058a7 <alltraps>
...
8010612a:	6a 69                	push   $0x69
  jmp alltraps
8010612c:	e9 76 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106133:	6a 6a                	push   $0x6a
  jmp alltraps
80106135:	e9 6d f7 ff ff       	jmp    801058a7 <alltraps>
...
8010613c:	6a 6b                	push   $0x6b
  jmp alltraps
8010613e:	e9 64 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106145:	6a 6c                	push   $0x6c
  jmp alltraps
80106147:	e9 5b f7 ff ff       	jmp    801058a7 <alltraps>
...
8010614e:	6a 6d                	push   $0x6d
  jmp alltraps
80106150:	e9 52 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106157:	6a 6e                	push   $0x6e
  jmp alltraps
80106159:	e9 49 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106160:	6a 6f                	push   $0x6f
  jmp alltraps
80106162:	e9 40 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106169:	6a 70                	push   $0x70
  jmp alltraps
8010616b:	e9 37 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106172:	6a 71                	push   $0x71
  jmp alltraps
80106174:	e9 2e f7 ff ff       	jmp    801058a7 <alltraps>
...
8010617b:	6a 72                	push   $0x72
  jmp alltraps
8010617d:	e9 25 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106184:	6a 73                	push   $0x73
  jmp alltraps
80106186:	e9 1c f7 ff ff       	jmp    801058a7 <alltraps>
...
8010618d:	6a 74                	push   $0x74
  jmp alltraps
8010618f:	e9 13 f7 ff ff       	jmp    801058a7 <alltraps>
...
80106196:	6a 75                	push   $0x75
  jmp alltraps
80106198:	e9 0a f7 ff ff       	jmp    801058a7 <alltraps>
...
8010619f:	6a 76                	push   $0x76
  jmp alltraps
801061a1:	e9 01 f7 ff ff       	jmp    801058a7 <alltraps>
...
801061a8:	6a 77                	push   $0x77
  jmp alltraps
801061aa:	e9 f8 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061b1:	6a 78                	push   $0x78
  jmp alltraps
801061b3:	e9 ef f6 ff ff       	jmp    801058a7 <alltraps>
...
801061ba:	6a 79                	push   $0x79
  jmp alltraps
801061bc:	e9 e6 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061c3:	6a 7a                	push   $0x7a
  jmp alltraps
801061c5:	e9 dd f6 ff ff       	jmp    801058a7 <alltraps>
...
801061cc:	6a 7b                	push   $0x7b
  jmp alltraps
801061ce:	e9 d4 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061d5:	6a 7c                	push   $0x7c
  jmp alltraps
801061d7:	e9 cb f6 ff ff       	jmp    801058a7 <alltraps>
...
801061de:	6a 7d                	push   $0x7d
  jmp alltraps
801061e0:	e9 c2 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061e7:	6a 7e                	push   $0x7e
  jmp alltraps
801061e9:	e9 b9 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061f0:	6a 7f                	push   $0x7f
  jmp alltraps
801061f2:	e9 b0 f6 ff ff       	jmp    801058a7 <alltraps>
...
801061f9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801061fe:	e9 a4 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106205:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010620a:	e9 98 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106211:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106216:	e9 8c f6 ff ff       	jmp    801058a7 <alltraps>
...
8010621d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106222:	e9 80 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106229:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010622e:	e9 74 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106235:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010623a:	e9 68 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106241:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106246:	e9 5c f6 ff ff       	jmp    801058a7 <alltraps>
...
8010624d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106252:	e9 50 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106259:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010625e:	e9 44 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106265:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010626a:	e9 38 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106271:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106276:	e9 2c f6 ff ff       	jmp    801058a7 <alltraps>
...
8010627d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106282:	e9 20 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106289:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010628e:	e9 14 f6 ff ff       	jmp    801058a7 <alltraps>
...
80106295:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010629a:	e9 08 f6 ff ff       	jmp    801058a7 <alltraps>
...
801062a1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062a6:	e9 fc f5 ff ff       	jmp    801058a7 <alltraps>
...
801062ad:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062b2:	e9 f0 f5 ff ff       	jmp    801058a7 <alltraps>
...
801062b9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062be:	e9 e4 f5 ff ff       	jmp    801058a7 <alltraps>
...
801062c5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062ca:	e9 d8 f5 ff ff       	jmp    801058a7 <alltraps>
...
801062d1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062d6:	e9 cc f5 ff ff       	jmp    801058a7 <alltraps>
...
801062dd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801062e2:	e9 c0 f5 ff ff       	jmp    801058a7 <alltraps>
...
801062e9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801062ee:	e9 b4 f5 ff ff       	jmp    801058a7 <alltraps>
...
801062f5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801062fa:	e9 a8 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106301:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106306:	e9 9c f5 ff ff       	jmp    801058a7 <alltraps>
...
8010630d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106312:	e9 90 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106319:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010631e:	e9 84 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106325:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010632a:	e9 78 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106331:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106336:	e9 6c f5 ff ff       	jmp    801058a7 <alltraps>
...
8010633d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106342:	e9 60 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106349:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010634e:	e9 54 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106355:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010635a:	e9 48 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106361:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106366:	e9 3c f5 ff ff       	jmp    801058a7 <alltraps>
...
8010636d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106372:	e9 30 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106379:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010637e:	e9 24 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106385:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010638a:	e9 18 f5 ff ff       	jmp    801058a7 <alltraps>
...
80106391:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106396:	e9 0c f5 ff ff       	jmp    801058a7 <alltraps>
...
8010639d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063a2:	e9 00 f5 ff ff       	jmp    801058a7 <alltraps>
...
801063a9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063ae:	e9 f4 f4 ff ff       	jmp    801058a7 <alltraps>
...
801063b5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063ba:	e9 e8 f4 ff ff       	jmp    801058a7 <alltraps>
...
801063c1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063c6:	e9 dc f4 ff ff       	jmp    801058a7 <alltraps>
...
801063cd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063d2:	e9 d0 f4 ff ff       	jmp    801058a7 <alltraps>
...
801063d9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063de:	e9 c4 f4 ff ff       	jmp    801058a7 <alltraps>
...
801063e5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801063ea:	e9 b8 f4 ff ff       	jmp    801058a7 <alltraps>
...
801063f1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801063f6:	e9 ac f4 ff ff       	jmp    801058a7 <alltraps>
...
801063fd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106402:	e9 a0 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106409:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010640e:	e9 94 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106415:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010641a:	e9 88 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106421:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106426:	e9 7c f4 ff ff       	jmp    801058a7 <alltraps>
...
8010642d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106432:	e9 70 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106439:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010643e:	e9 64 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106445:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010644a:	e9 58 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106451:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106456:	e9 4c f4 ff ff       	jmp    801058a7 <alltraps>
...
8010645d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106462:	e9 40 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106469:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010646e:	e9 34 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106475:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010647a:	e9 28 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106481:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106486:	e9 1c f4 ff ff       	jmp    801058a7 <alltraps>
...
8010648d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106492:	e9 10 f4 ff ff       	jmp    801058a7 <alltraps>
...
80106499:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010649e:	e9 04 f4 ff ff       	jmp    801058a7 <alltraps>
...
801064a5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064aa:	e9 f8 f3 ff ff       	jmp    801058a7 <alltraps>
...
801064b1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064b6:	e9 ec f3 ff ff       	jmp    801058a7 <alltraps>
...
801064bd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064c2:	e9 e0 f3 ff ff       	jmp    801058a7 <alltraps>
...
801064c9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064ce:	e9 d4 f3 ff ff       	jmp    801058a7 <alltraps>
...
801064d5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064da:	e9 c8 f3 ff ff       	jmp    801058a7 <alltraps>
...
801064e1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801064e6:	e9 bc f3 ff ff       	jmp    801058a7 <alltraps>
...
801064ed:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801064f2:	e9 b0 f3 ff ff       	jmp    801058a7 <alltraps>
...
801064f9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801064fe:	e9 a4 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106505:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010650a:	e9 98 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106511:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106516:	e9 8c f3 ff ff       	jmp    801058a7 <alltraps>
...
8010651d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106522:	e9 80 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106529:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010652e:	e9 74 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106535:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010653a:	e9 68 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106541:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106546:	e9 5c f3 ff ff       	jmp    801058a7 <alltraps>
...
8010654d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106552:	e9 50 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106559:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010655e:	e9 44 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106565:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010656a:	e9 38 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106571:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106576:	e9 2c f3 ff ff       	jmp    801058a7 <alltraps>
...
8010657d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106582:	e9 20 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106589:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010658e:	e9 14 f3 ff ff       	jmp    801058a7 <alltraps>
...
80106595:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010659a:	e9 08 f3 ff ff       	jmp    801058a7 <alltraps>
...
801065a1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065a6:	e9 fc f2 ff ff       	jmp    801058a7 <alltraps>
...
801065ad:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065b2:	e9 f0 f2 ff ff       	jmp    801058a7 <alltraps>
...
801065b9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065be:	e9 e4 f2 ff ff       	jmp    801058a7 <alltraps>
...
801065c5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065ca:	e9 d8 f2 ff ff       	jmp    801058a7 <alltraps>
...
801065d1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065d6:	e9 cc f2 ff ff       	jmp    801058a7 <alltraps>
...
801065dd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801065e2:	e9 c0 f2 ff ff       	jmp    801058a7 <alltraps>
...
801065e9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801065ee:	e9 b4 f2 ff ff       	jmp    801058a7 <alltraps>
...
801065f5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801065fa:	e9 a8 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106601:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106606:	e9 9c f2 ff ff       	jmp    801058a7 <alltraps>
...
8010660d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106612:	e9 90 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106619:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010661e:	e9 84 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106625:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010662a:	e9 78 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106631:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106636:	e9 6c f2 ff ff       	jmp    801058a7 <alltraps>
...
8010663d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106642:	e9 60 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106649:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010664e:	e9 54 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106655:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010665a:	e9 48 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106661:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106666:	e9 3c f2 ff ff       	jmp    801058a7 <alltraps>
...
8010666d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106672:	e9 30 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106679:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010667e:	e9 24 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106685:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010668a:	e9 18 f2 ff ff       	jmp    801058a7 <alltraps>
...
80106691:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106696:	e9 0c f2 ff ff       	jmp    801058a7 <alltraps>
...
8010669d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066a2:	e9 00 f2 ff ff       	jmp    801058a7 <alltraps>
...
801066a9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066ae:	e9 f4 f1 ff ff       	jmp    801058a7 <alltraps>
...
801066b5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066ba:	e9 e8 f1 ff ff       	jmp    801058a7 <alltraps>
...
801066c1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066c6:	e9 dc f1 ff ff       	jmp    801058a7 <alltraps>
...
801066cd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066d2:	e9 d0 f1 ff ff       	jmp    801058a7 <alltraps>
...
801066d9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066de:	e9 c4 f1 ff ff       	jmp    801058a7 <alltraps>
...
801066e5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801066ea:	e9 b8 f1 ff ff       	jmp    801058a7 <alltraps>
...
801066f1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801066f6:	e9 ac f1 ff ff       	jmp    801058a7 <alltraps>
...
801066fd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106702:	e9 a0 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106709:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010670e:	e9 94 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106715:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010671a:	e9 88 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106721:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106726:	e9 7c f1 ff ff       	jmp    801058a7 <alltraps>
...
8010672d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106732:	e9 70 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106739:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010673e:	e9 64 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106745:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010674a:	e9 58 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106751:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106756:	e9 4c f1 ff ff       	jmp    801058a7 <alltraps>
...
8010675d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106762:	e9 40 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106769:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010676e:	e9 34 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106775:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010677a:	e9 28 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106781:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106786:	e9 1c f1 ff ff       	jmp    801058a7 <alltraps>
...
8010678d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106792:	e9 10 f1 ff ff       	jmp    801058a7 <alltraps>
...
80106799:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010679e:	e9 04 f1 ff ff       	jmp    801058a7 <alltraps>
...
801067a5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067aa:	e9 f8 f0 ff ff       	jmp    801058a7 <alltraps>
...
801067b1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067b6:	e9 ec f0 ff ff       	jmp    801058a7 <alltraps>
...
801067bd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067c2:	e9 e0 f0 ff ff       	jmp    801058a7 <alltraps>
...
801067c9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067ce:	e9 d4 f0 ff ff       	jmp    801058a7 <alltraps>
...
801067d5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067da:	e9 c8 f0 ff ff       	jmp    801058a7 <alltraps>
...
801067e1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067e6:	e9 bc f0 ff ff       	jmp    801058a7 <alltraps>
...
801067ed:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801067f2:	e9 b0 f0 ff ff       	jmp    801058a7 <alltraps>
...
{
80106808:	89 d7                	mov    %edx,%edi
  pde = &pgdir[PDX(va)];
8010680a:	c1 eb 16             	shr    $0x16,%ebx
8010680d:	8d 34 98             	lea    (%eax,%ebx,4),%esi
{
80106810:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
80106813:	8b 06                	mov    (%esi),%eax
80106815:	a8 01                	test   $0x1,%al
80106817:	74 27                	je     80106840 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106819:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010681e:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
  ...
  return &pgtab[PTX(va)];
80106824:	c1 ef 0a             	shr    $0xa,%edi
}
80106827:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
8010682a:	89 fa                	mov    %edi,%edx
...
80106844:	e8 87 bc ff ff       	call   801024d0 <kalloc>
...
801068fd:	68 0c 7a 10 80       	push   $0x80107a0c
...
8010692c:	73 66                	jae    80106994 <deallocuvm.part.0+0x84>
...
80106945:	74 58                	je     8010699f <deallocuvm.part.0+0x8f>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
...
80106954:	e8 c7 b9 ff ff       	call   80102320 <kfree>
      *pte = 0;
...
8010696d:	73 25                	jae    80106994 <deallocuvm.part.0+0x84>
    pte = walkpgdir(pgdir, (char*)a, 0);
...
8010697c:	75 ba                	jne    80106938 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010697e:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106984:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010698a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106990:	39 f3                	cmp    %esi,%ebx
80106992:	72 db                	jb     8010696f <deallocuvm.part.0+0x5f>
    }
  }
  return newsz;
}
80106994:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
801069a2:	68 a6 73 10 80       	push   $0x801073a6
...
801069bb:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
  pd[0] = size-1;
801069c1:	ba 2f 00 00 00       	mov    $0x2f,%edx
801069c6:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801069ca:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
801069d1:	ff 00 00 
801069d4:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
801069db:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801069de:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
801069e5:	ff 00 00 
801069e8:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
801069ef:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801069f2:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
801069f9:	ff 00 00 
801069fc:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
80106a03:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a06:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
80106a0d:	ff 00 00 
80106a10:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
80106a17:	f2 cf 00 
...
80106a40:	a1 44 58 11 80       	mov    0x80115844,%eax
{
...
80106a84:	0f 84 c2 00 00 00    	je     80106b4c <switchuvm+0xec>
  pushcli();
80106a8a:	e8 21 da ff ff       	call   801044b0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a8f:	e8 2c ce ff ff       	call   801038c0 <mycpu>
80106a94:	89 c6                	mov    %eax,%esi
80106a96:	e8 25 ce ff ff       	call   801038c0 <mycpu>
80106a9b:	89 c7                	mov    %eax,%edi
80106a9d:	e8 1e ce ff ff       	call   801038c0 <mycpu>
80106aa2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106aa5:	83 c7 08             	add    $0x8,%edi
80106aa8:	e8 13 ce ff ff       	call   801038c0 <mycpu>
...
80106abb:	66 89 96 98 00 00 00 	mov    %dx,0x98(%esi)
80106ac2:	66 89 be 9a 00 00 00 	mov    %di,0x9a(%esi)
80106ac9:	88 86 9f 00 00 00    	mov    %al,0x9f(%esi)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106acf:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ad4:	83 c1 08             	add    $0x8,%ecx
80106ad7:	c1 e9 10             	shr    $0x10,%ecx
...
80106af1:	e8 ca cd ff ff       	call   801038c0 <mycpu>
...
80106b09:	e8 b2 cd ff ff       	call   801038c0 <mycpu>
80106b0e:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106b14:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b17:	e8 a4 cd ff ff       	call   801038c0 <mycpu>
...
80106b8b:	77 49                	ja     80106bd6 <inituvm+0x66>
  mem = kalloc();
80106b8d:	e8 3e b9 ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b9f:	e8 ec da ff ff       	call   80104690 <memset>
...
80106bd9:	68 51 7a 10 80       	push   $0x80107a51
...
80106c33:	e8 c8 fb ff ff       	call   80106800 <walkpgdir>
...
80106c61:	e8 0a ad ff ff       	call   80101970 <readi>
80106c66:	83 c4 10             	add    $0x10,%esp
80106c69:	39 f8                	cmp    %edi,%eax
...
80106cbe:	0f 88 8e 00 00 00    	js     80106d52 <allocuvm+0xa2>
  if(newsz < oldsz)
80106cc4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106cc7:	0f 82 93 00 00 00    	jb     80106d60 <allocuvm+0xb0>
  a = PGROUNDUP(oldsz);
...
80106cdf:	0f 86 7e 00 00 00    	jbe    80106d63 <allocuvm+0xb3>
...
80106d07:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d0c:	5a                   	pop    %edx
80106d0d:	6a 06                	push   $0x6
...
80106d1e:	78 50                	js     80106d70 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
80106d20:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106d26:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80106d29:	0f 86 81 00 00 00    	jbe    80106db0 <allocuvm+0x100>
    mem = kalloc();
80106d2f:	e8 9c b7 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
...
80106d3d:	68 89 7a 10 80       	push   $0x80107a89
80106d42:	e8 19 99 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106d47:	83 c4 10             	add    $0x10,%esp
80106d4a:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d4d:	39 45 10             	cmp    %eax,0x10(%ebp)
80106d50:	77 6e                	ja     80106dc0 <allocuvm+0x110>
}
80106d52:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80106d55:	31 ff                	xor    %edi,%edi
}
...
80106d5e:	66 90                	xchg   %ax,%ax
    return oldsz;
80106d60:	8b 7d 0c             	mov    0xc(%ebp),%edi
}
...
80106d73:	68 a1 7a 10 80       	push   $0x80107aa1
80106d78:	e8 e3 98 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80106d7d:	83 c4 10             	add    $0x10,%esp
80106d80:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d83:	39 45 10             	cmp    %eax,0x10(%ebp)
80106d86:	76 0d                	jbe    80106d95 <allocuvm+0xe5>
80106d88:	89 c1                	mov    %eax,%ecx
80106d8a:	8b 55 10             	mov    0x10(%ebp),%edx
80106d8d:	8b 45 08             	mov    0x8(%ebp),%eax
80106d90:	e8 7b fb ff ff       	call   80106910 <deallocuvm.part.0>
      kfree(mem);
...
80106d9b:	e8 80 b5 ff ff       	call   80102320 <kfree>
      return 0;
...
80106db0:	8b 7d e4             	mov    -0x1c(%ebp),%edi
...
80106dc0:	89 c1                	mov    %eax,%ecx
80106dc2:	8b 55 10             	mov    0x10(%ebp),%edx
80106dc5:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
80106dc8:	31 ff                	xor    %edi,%edi
80106dca:	e8 41 fb ff ff       	call   80106910 <deallocuvm.part.0>
80106dcf:	eb 92                	jmp    80106d63 <allocuvm+0xb3>
80106dd1:	eb 0d                	jmp    80106de0 <deallocuvm>
80106dd3:	90                   	nop
80106dd4:	90                   	nop
80106dd5:	90                   	nop
80106dd6:	90                   	nop
...
80106e29:	e8 e2 fa ff ff       	call   80106910 <deallocuvm.part.0>
...
80106e5e:	e8 bd b4 ff ff       	call   80102320 <kfree>
...
80106e73:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e74:	e9 a7 b4 ff ff       	jmp    80102320 <kfree>
    panic("freevm: no pgdir");
80106e79:	83 ec 0c             	sub    $0xc,%esp
80106e7c:	68 bd 7a 10 80       	push   $0x80107abd
...
80106e95:	e8 36 b6 ff ff       	call   801024d0 <kalloc>
...
80106eb0:	e8 db d7 ff ff       	call   80104690 <memset>
...
80106f1b:	a3 44 58 11 80       	mov    %eax,0x80115844
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f4f:	68 ce 7a 10 80       	push   $0x80107ace
...
80106fac:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106fb1:	5a                   	pop    %edx
80106fb2:	ff 75 e4             	pushl  -0x1c(%ebp)
80106fb5:	50                   	push   %eax
80106fb6:	89 fa                	mov    %edi,%edx
...
80106fea:	25 ff 0f 00 00       	and    $0xfff,%eax
    pa = PTE_ADDR(*pte);
80106fef:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    flags = PTE_FLAGS(*pte);
80106ff5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106ff8:	e8 d3 b4 ff ff       	call   801024d0 <kalloc>
...
80107011:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
...
80107080:	c3                   	ret    
80107081:	eb 0d                	jmp    80107090 <copyout>
80107083:	90                   	nop
80107084:	90                   	nop
80107085:	90                   	nop
80107086:	90                   	nop
...
801070cf:	e8 6c d6 ff ff       	call   80104740 <memmove>
    len -= n;
    buf += n;
